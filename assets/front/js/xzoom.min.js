...
function detect_old_ie() {
    ...
    function a(ax, aG) {
        ...
        this.xappend = function(u,sku_sequence) {

            //console.log(sku_sequence,34343434);

            var sku_sequence = $('#img_sku_sequence').val();

            if(sku_sequence!='' || sku_sequence!=null || sku_sequence!=undefined)
            {
            ...
            F[aC] = v.attr("href");
            v.data("xindex", aC);
            if (aC == sku_sequence && E.options.activeClass) {
                K = u;
