...
class LeadConversationController extends Controller
{
    ...
    */
    ...
    {       
 		...
 		$this->module_url_path         = url($this->retailer_panel_slug.'/leads_by_representative');
    ...
    public function index($lead_id = 0)
    {
    	...
    	//get quote details
    	$lead_obj = $this->RepresentativeLeadsModel->with(['representative_user_details'])->where('id',$lead_id)->first();
    	...
    	{
    		Flash::error('No lead found,please try again.');
        ...
        $receiver_id = $lead_arr['representative_id'] or 0;
        ...
        $this->LeadConversationModel->where('lead_id',$lead_id)->update(['is_maker_viewed'=>1]);
