...
class QuoteConversationController extends Controller
{
    ...
    {       
 		...
 		$this->module_view_folder      = 'maker.conversation';
 		$this->retailer_panel_slug     = config('app.project.maker_panel_slug');
 		$this->module_url_path         = url($this->retailer_panel_slug.'/retailer_quotes');
    ...
    public function index($quote_id = 0)
    {
    	...
    	//get quote details
    	$quote_obj = $this->RetailerQuotesModel->with(['user_details'])
    	...
    	{
    		Flash::error('No quote found, please try again later');
        ...
        $receiver_id = $quote_arr['retailer_id'] or 0;
        ...
        $this->QuotesConversationModel->where('quote_id',$quote_id)->update(['is_maker_viewed'=>1]);
    ...
    public function get_message(Request $request)
    {
        ...
        // $receiver_id = $trade_arr['seller_details']['user_details']['id'] or 0;
