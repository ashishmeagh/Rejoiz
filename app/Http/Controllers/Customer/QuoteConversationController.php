...
class QuoteConversationController extends Controller
{
    ...
    {       
 		...
 		$this->module_view_folder      = 'retailer.conversation';
    ...
    public function index($quote_id = 0)
    {
    	...
    	//get quote details
    	$quote_obj = $this->RetailerQuotesModel->with(['maker_brand_details','maker_details'])
        ...
        $receiver_id = $quote_arr['maker_id'] or 0;
        ...
        $this->QuotesConversationModel->where('quote_id',$quote_id)->update(['is_retailer_viewed'=>1]);                                                          
