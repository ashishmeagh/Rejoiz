...
class NotificationsController extends Controller
{
    ...
    {      
        ...
        $this->module_view_folder= "representative/notifications"; 
        $this->module_url_path   = url(config('app.project.representative_panel_slug')."/notifications");
    }
     /*
    ...
    */ 
    ...
    public function index()
    {
        ...
        //$update_read_status = $this->BaseModel->where('type','representative')->update(['is_read'=>'1']);
