...
class RequestThirdSubCategoryController extends Controller
{
    	                       ...
    	                       )
    {
      ...
      $this->module_view_folder              =   "admin.request_third_category";
      $this->module_title                    =   "Request Third Level Categories";
      $this->module_url_path                 =   url(config('app.project.admin_panel_slug').'/request_third_sub_categories');      
    ...
    function get_category_details(Request $request)
    {
        ...
        $obj_subcategory = DB::table($third_sub_category_details)
                                ->select(DB::raw($prefixed_third_sub_category.".id,".
                                                ...
                                                $prefixed_sub_category_trans.'.subcategory_name,'.
                                                 ...
                                                 $prefixed_third_sub_category.'.admin_confirm_status,'.
                                                 $prefixed_third_sub_category.'.reject_reason'
                                                ))
                                ...
                                ->where($prefixed_third_sub_category.'.admin_confirm_status','!=','0')
                                ->where($prefixed_third_sub_category.'.is_active','=','0')
        ...
        if(isset($arr_search_column['q_status']) && $arr_search_column['q_status']!="")
        {
            ...
            $obj_subcategory = $obj_subcategory->where($third_sub_category_details.'.admin_confirm_status',$search_term);
        }
    ...
    public function status_update(Request $request)
    {
        ...
        try
        {
            ...
            $obj_get_category = $this->ThirdSubCategoryModel->where('id', $category_id)->get()->toArray();
            ...
            $response['link'] = url('/admin/request_third_sub_categories');
    ...
    public function view($enc_id)
    {
        ...
        $subcat_data = [];
        $obj_data = $this->ThirdSubCategoryModel->where('id', $id)->with(['translations'])->first();
        $arr_data = [];
        ...
        if($obj_data)
        {
           ...
           if(!empty($arr_data)){
                $obj_cat_data = $this->SubCategoryModel->where('id', $arr_data['sub_category_id'])->get()->toArray();
           ...
           $subcat_data['third_sub_category_name'] = $arr_data['third_sub_category_name'];
           $subcat_data['sub_category_name'] = $subcategory_name;
           $subcat_data['third_sub_category_id'] = $arr_data['id'];
  ...
  {   
      $static_page = $this->ThirdSubCategoryModel->where('id',$id)->first();
        
      if($static_page)
      {          
          {           
            $updateProduct = $this->ThirdSubCategoryModel->where('id',$id)->update(['admin_confirm_status'=>'0','request_cat_update_date' => date('Y-m-d H:i:s'),'is_active' => 1]);
  ...
  {   
      ...
      {          
          {           
            $updateProduct = $this->ThirdSubCategoryModel->where('id',$id)->update(['admin_confirm_status'=>'1','request_cat_update_date' => date('Y-m-d H:i:s')]);
            return $updateProduct;             
          }
