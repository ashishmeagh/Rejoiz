...
class RequestFourthSubCategoryController extends Controller
{
    	                       ...
    	                       )
    {
      ...
      $this->module_view_folder              =   "admin.request_fourth_category";
      $this->module_title                    =   "Request Fourth Level Categories";
      $this->module_url_path                 =   url(config('app.project.admin_panel_slug').'/request_fourth_sub_categories');      
    ...
    function get_category_details(Request $request)
    {
        ...
        $third_sub_category_details = $this->ThirdSubCategoryModel->getTable();
        $prefixed_third_sub_category = DB::getTablePrefix().$this->ThirdSubCategoryModel->getTable();
        ...
        $obj_subcategory = DB::table($fourth_sub_category_details)
                                ->select(DB::raw($prefixed_fourth_sub_category.".id,".
                                                ...
                                                $prefixed_sub_category_trans.'.subcategory_name,'.
                                                 ...
                                                 $prefixed_fourth_sub_category.'.admin_confirm_status,'.
                                                 $prefixed_fourth_sub_category.'.reject_reason'
                                                ))
                                ...
                                ->where($prefixed_fourth_sub_category.'.admin_confirm_status','!=','0')
                                ->where($prefixed_fourth_sub_category.'.is_active','=','0')
                                ->whereNull($fourth_sub_category_details.'.deleted_at')
                                ->where($prefixed_third_category_trans_tbl.'.locale','en')
                                ->orderBy('id','DESC');                                         
        ...
        if(isset($arr_search_column['q_status']) && $arr_search_column['q_status']!="")
        {
            ...
            $obj_subcategory = $obj_subcategory->where($fourth_sub_category_details.'.admin_confirm_status',$search_term);
        }
    ...
    public function status_update(Request $request)
    {
        ...
        try
        {
            ...
            $obj_get_category = $this->FourthSubCategoryModel->where('id', $category_id)->get()->toArray();
            ...
            $response['link'] = url('/admin/request_fourth_sub_categories');
    ...
    public function view($enc_id)
    {
        ...
        if($obj_data)
        {
           ...
           if(!empty($arr_data)){
                $obj_cat_data = $this->SubCategoryModel->where('id', $arr_data['second_sub_category_id'])->get()->toArray();

                if(!empty($obj_cat_data)){
                    $subcategory_name = $obj_cat_data[0]['subcategory_name'];
                }
           }
           if(!empty($arr_data)){
           ...
           if(!empty($arr_data)){
                $obj_cat_data = $this->ThirdSubCategoryModel->where('id', $arr_data['third_sub_category_id'])->get()->toArray();

                if(!empty($obj_cat_data)){
                    $third_category_name = $obj_cat_data[0]['third_sub_category_name'];
                }
           }
           $subcat_data['category_name'] = $category_name;
           $subcat_data['third_sub_category_name'] = $third_category_name;
           $subcat_data['fourth_sub_category_name'] = $arr_data['fourth_sub_category_name'];
           $subcat_data['sub_category_name'] = $subcategory_name;
           $subcat_data['fourth_sub_category_id'] = $arr_data['id'];
  ...
  {   
      $static_page = $this->FourthSubCategoryModel->where('id',$id)->first();
        
      if($static_page)
      {          
          {           
            $updateProduct = $this->FourthSubCategoryModel->where('id',$id)->update(['admin_confirm_status'=>'0','request_cat_update_date' => date('Y-m-d H:i:s'),'is_active' => 1]);
  ...
  {   
      ...
      {          
          {           
            $updateProduct = $this->FourthSubCategoryModel->where('id',$id)->update(['admin_confirm_status'=>'1','request_cat_update_date' => date('Y-m-d H:i:s')]);
            return $updateProduct;             
          }
