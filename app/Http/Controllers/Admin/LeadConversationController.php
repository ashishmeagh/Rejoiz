...
class LeadConversationController extends Controller
{
    ...
    */
    ...
    public function index($lead_id = 0)
    {
        ...
        $representative_id = $lead_arr['representative_id'] or 0;
        $maker_id 		   = $lead_arr['maker_id'] or 0;

		$msg_id_arr  = [$admin_id,$representative_id,$maker_id];
        ...
        $this->LeadConversationModel->where('lead_id',$lead_id)->update(['is_admin_viewed'=>1]);
