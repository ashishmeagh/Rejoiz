...
class NotificationsController extends Controller
{
    ...
    {      
        ...
        $this->module_view_folder= "retailer/notifications"; 
        $this->module_url_path   = url(config('app.project.retailer_panel_slug')."/notifications");
    }
     /*
    ...
    */ 
    ...
    public function index()
    {
        ...
        //$update_read_status = $this->BaseModel->where('type','retailer')->update(['is_read'=>'1']);
