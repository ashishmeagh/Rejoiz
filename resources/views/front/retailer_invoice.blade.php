...
<table width="100%" bgcolor="#fff" border="0" cellspacing="0" cellpadding="0" style="border:0px solid #ddd;font-family:Arial, Helvetica, sans-serif;">
    ...
    <tr>
        <td colspan="2" style="padding:10px 30px 10px 30px; font-size:12px;">
            <table width="100%">
             ...
             <td width="30%" style="font-size:12px; text-align: left;"> <h3 style="margin-bottom: 5px;">Order From (Retailer ) :</h3>
                <div class = "data_container">
                    <b>{{$retailer_data['store_name'].'<br>' or ''}}</b>
                    <b>{{$retailer_data['store_website'].'<br>' or ''}}</b>
    ...
    <tr>
        <td colspan="2" style="padding: 20px 20px 5px; color: #ffd8b8; background-color: #404040; text-align: center;"> If you have any questions about this invoice, please contact
        </td>
    </tr>
    <tr>
         <td colspan="2"style="text-align: center; color: #653b18; font-size: 13px; background-color: #404040;">
