...
$total_order_amount = $total_admin_commission = $total_vendor_commission = $total_vendor_commission = 0;
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td  style="text-align:left; ">
                        ...
                        Company Name : {{isset($company_name)?$company_name.'.':'N/A'}}                         <br>
                        Vendor Name  : {{isset($arrUserData['personla_details']['first_name'])?$arrUserData['personla_details']['first_name']:''}} {{isset($arrUserData['personla_details']['last_name'])?$arrUserData['personla_details']['last_name']:'N/A'}}<br>
                        Address:
                        {{-- <div class="data_container"> --}}
                          {{isset($arrUserData['personla_details']['address'])?$arrUserData['personla_details']['address']:'N/A'}}
                             <br>
        ...
        <td colspan="2">
            ...
            <table width="100%" cellspacing="0" cellpadding="10" style="font-size: 13px;">
                <tr style="background-color:#eeeff1;">
                    ...
                    <th align="left" width="10%">Admin Commission($)</th>
                    <th align="left" width="10%">Amount Payable to Admin</th>                    
                </tr>
                ...
                @if(isset($arrOrderData['rep_sales_order_data']) && count($arrOrderData['rep_sales_order_data']) > 0)
                  ...
                  @php
                      ...
                      //$admin_pay_amount = $order_amount - $admin_commission_amount;
                      $admin_pay_amount =$admin_commission_amount;

                      
                      $total_order_amount             += $order_amount;
                      $total_admin_commission        += $admin_commission_amount;
                      $total_vendor_commission        += $admin_pay_amount;
                    ...
                    <tr>
                        ...
                        <td align="left">${{isset($admin_pay_amount)?num_format($admin_pay_amount):0}}</td>
                 ...
                 @if(isset($arrOrderData['customer_order_data']) && count($arrOrderData['customer_order_data']) > 0)
                   ...
                   @foreach($arrOrderData['customer_order_data'] as $CustomerKey => $CustomerData)
                    ...
                    <tr>
                        ...
                        <td align="left">${{isset($order_amount)?num_format($order_amount):0}}</td>
                        <td align="left">{{isset($CustomerData['admin_commission'])?num_format($CustomerData['admin_commission']):0}}</td>
                        <td align="left">${{isset($admin_commission_amount)?num_format($admin_commission_amount):0}}</td>
                        <td align="left">${{isset($admin_pay_amount)?num_format($admin_pay_amount):0}}</td>
