...
.rightbagsidebar{position: -webkit-sticky;
  ...
  .qty-shop-bg b {word-break: break-all;}
  ...
  .gt-button{
    ...
    .bag-clone-group{padding:10px 0px;}
...
@php
// dump(Session::get('promotion_data'))
            ...
            <div class="row">
                <div class="col-lg-8 col-md-8 leftbagsidebar">
                    <div class="white-box theiaStickySidebar mybagleftbox">
                        ...
                        <div class="row">
                            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6"> <div class="title-shopping">Shopping Bag</div></div>
                            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                             <div class="continue-shopping-bag mg-spc-tp pull-right mt-0 my-bag-conitnue-shopping-btn">
                        ...
                        @if(isset($product_details['product_details']) && sizeof($product_details['product_details'])>0)    
                        <div class="bag-clone-group customer-bag-clone-group">
                            <div class="jst-mybg">
                                ...
                                <div class="row">
                                    ...
                                    <div class="brand-name-title spc-top" data-brand="{{ $product_details['maker_details']['id'] or '' }}" data-brand-min="{{ $maker_amount or '' }}">{{ $product_details['maker_details']['company_name'] or '' }}</div>
                                 ...
                                 {{--    @if(isset($product_details['maker_details']['shop_settings']['first_order_minimum']) && $product_details['maker_details']['shop_settings']['first_order_minimum']==0)
                                  ...
                                  {{--   @if(isset($product_details['maker_details']['shop_settings']['first_order_minimum']) && $product_details['maker_details']['shop_settings']['first_order_minimum']==0)
                                    ...
                                    @endif --}}
                                      ...
                                      @if(isset($maker_amount) && $maker_amount ==0 )

                                        <div class="save-it-main">No Minimum Limit</div>
                                    @else
                                        <div class="save-it-main"><b>{{isset($maker_amount)?'Minimum Order Amount: $'.$maker_amount:'No Minimum Limit'}}</b></div>
                                    @endif
                           ...
                           @endif
                            ...
                            <div class="row">
                                ...
                                <div class="coupncode-inpt newcoupncode">
                                    ...
                                    @if(isset($session_promotion_data[$key]))

                                        
                                        <input type="text" placeholder="Enter Promo Code" name="promo_code" readonly="" value="{{ $session_promotion_data[$key]['promo_code'] or ''}}" />

                                        <button type="button" class="cpn-buttons cpn-clrs-btn" id="btn_apply_code" name="btn_apply_code" onclick="clearPromoCode({{$key}});"><i class="fa fa-times"> </i> Clear</button>

                                        
                                        
                                    @else
                                        
                                        <input type="text" placeholder="Enter Promo Code" id="promo_code_{{$key}}" name="promo_code" data-parsley-required="true"/>
                                        
                                        <button type="button" class="cpn-buttons" id="btn_apply_code" name="btn_apply_code" onclick="applyPromoCode({{$key}});"><i class="fa fa-check"> </i> Apply</button>
                                        <span class="red" id="{{$key}}_promo_error"></span>
                                            ...
                                            <div class="brand-dtls-nw shopping-bag-main mybx-main-shop">
                                                ...
                                                <div class="brnd-dtls-mn">
                                                    ...
                                                    <div class="inpt-selects qty-bg">
                                                        ...
                                                        <div class="qty-shop-bg">Color: <b>{{ isset($details['color'])?$details['color'] : '' }}</b></div><br>
                                                        @endif
                                                        @if(isset($details['size_id']) && $details['size_id'] != "")
                                                        @php
                                                           $size = get_size_from_id($details['size_id']); 

                                                        @endphp
                                                        
                                                        <div class="qty-shop-bg" id="size">Size :  <b>{{ $size }}</b></div><br>
                                                        @endif
                                                        @php
                                ...
                                {{-- ******* --}}               @php  
                                                        ...
                                                        @if(isset($details['shipping_discount']))
...
/*
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            if(is_numeric($details['product_dis amount']) &&
                                                                ...
                                                                is_numeric($details['shipping_charges']))
                                                            { 
                                                                // dd($details['product_dis amount'],$details['shipping_discount'],$details['total_wholesale_price'],$details['shipping_charges']);
                                                        ...
                                                        @if($login_user==true && $login_user->inRole('retailer'))
                                                            ...
                                                            <div class="price-bnd-dtls">
                                                                ...
                                                                <b>$<span id="product_wholesale_total{{$details['sku_no']}}" data-maker-id="{{$key}}" data-brand-id="{{ isset($product_details['maker_details']['id'])?$product_details['maker_details']['id']:'' }}">{{ isset($product_wise_total)?num_format($product_wise_total) : '' }}
                                                                </span></b>
                                                            </div>
                                                            <div class="clearfix"></div>
                                                        ...
                                                        @else 
                                                            ...
                                                            <div class="price-bnd-dtls"><span>Total Order Amount:<b>$</span><span id="product_wholesale_total{{$details['sku_no']}}" data-maker-id="{{$key}}" data-brand-id="{{ isset($product_details['maker_details']['id'])?$product_details['maker_details']['id']:'' }}">{{ isset($product_wise_total)?num_format($product_wise_total) : '' }}</span></b></div>
                                                            <div class="clearfix"></div>
                                                        ...
                                                        <div class="main-qnt-bottom">
                                                            ...
                                                            @php
                                                                $prod_min_qty = isset($details['product_min_qty'])?$details['product_min_qty']:1;
                                                            @endphp

                                                             <select name="pro_qty" class="pro_qty" data-sku-no="{{base64_encode($details['sku_no'])}}" 
                                                             data-sku-color="{{$details['color'] or ''}}"
                                                             data-sku-size="{{$details['size_id'] or ''}}"
                                                             data-parsley-max = "10000" data-pro-id="{{base64_encode($details['product_id'])}}" @if(isset($product_available_quantity) && $product_available_quantity==0) disabled="true" @endif>

                                                                @for($i=$prod_min_qty;$i
                                                                <=10000;$i++) <option @if(isset($details[ 'item_qty']) && $details[ 'item_qty']==$i) selected="" @endif value="{{$i}}">{{$i}}</option>
                                                                    @endfor
                                                            </select>
                                                ...
                                                <div class="clearfix"></div>
                                                <a href="{{url('/my_bag/delete_product/'.base64_encode($details['sku_no']))}}" class="close-brnd" onclick="confirm_action(this,event,'Are you sure? Do you want to delete this product from bag.');">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <a class="gt-button mrtp pull-right" id=empty_cart>Empty Bag</a> 
                                <div class="clearfix"></div>
                            </div>
                        </div>
                        @else
                        <div class="not-found-data whitebg-no">Your shopping bag is empty.</div>
                        @endif    
                        ...
                        @if(isset($arr_final_data) && count($arr_final_data)>0 && $bag_count!=0)
                         ...
                         <div class="bag-details">
                            ...
                            <div class="innerbag-details">
                               ...
                               $shipping_chargs = $wholesale_total = $wholesale_subtotal = $total_ship_discount_value_perc = $total_ship_discount_value_dollar = $total_product_dis_value_perc = $total_product_dis_value_dollar = 0;
...
{{-- 
                                                ...
                                                @if(($shipping_charg>0 || $shipping_charg==0) && ($arr_product_data['shipping_charges']!=0))
                                                     @php $none = "display:block"; @endphp
                                                @else
                                                   @php $none = "display:none"; @endphp
                                                @endif
                    ...
                    @endif
                            ...
                            @endif
                                ...
                                <div class="mybag-list">
                                    ...
                                    @if($product_discount==0)
                                       @php $none ="display:none"; @endphp
                                    @endif
                                    {{--  <span style="{{$none or ''}}"><div class="mybag-list-left">Product Discount --}} {{-- {{isset($prod_dis_value_percent)?$prod_dis_value_percent:''}} {{isset($prod_dis_value_dollar)?$prod_dis_value_dollar:''}} --}} {{-- </div></span> --}}
                                    {{--  <span style="{{$none or ''}}"><div class="mybag-list-right"></div></span>
                                    <span style="{{$none or ''}}"><div class="mybag-list-right">@if($product_discount>0)-@endif${{isset($product_discount)?num_format($product_discount):0.00}}</div></span>
                                ...
                                <div class="mybag-list">
                                    ...
                                    <span style="{{$none or ''}}"><div class="mybag-list-left"> {{--Discount On Shipping {{isset($total_ship_percent)?$total_ship_percent:''}}{{isset($total_ship_dollar)?$total_ship_dollar:''}} --}} </div></span>

                                    <span style="{{$none or ''}}"><div class="mybag-list-right">{{-- @if($shipping_discount>0)-@endif${{isset($shipping_discount)?num_format($shipping_discount):0.00}} --}}</span>
                                ...
                                <h5>Order Total 
                                    ...
                                    if($login_user==true &&  $login_user->inRole('customer'))
                                    {
                                        ...
                                        $total_amount = $subtotal - $total_promotion_discount_amt;
                                         ...
                                         $total_amount = $wholesale_subtotal - $total_promotion_discount_amt;
                                    }
                                    @endphp
                        ...
                        <form id="frm-apply-quotes">
                            ...
                            <div class="button-login-pb">
                                ...
                                <a href="javascript:void(0)" onclick="save_bag();" class="gt-button apply-quotes">Order Now</a> 
                                @else
                                <a href="javascript:void(0)" onclick="save_bag();" class="gt-button apply-quotes">Order Now</a> 
                                @endif
    ...
    <script type="text/javascript">
        $('.pro_qty').on('change', function() 
        {
            ...
            var color = $(this).attr("data-sku-color");
            var size = $(this).attr("data-sku-size");
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status == "SUCCESS") {
                        ...
                        //Temporary comment  when QA team told then un-comment below line 
                        //applyPromoCode(maker_id);
        ...
        $('#empty_cart').on('click', function() {
            ...
            swal({
                    ...
                    text: "Are you sure? Do you want to delete all products from bag.",
                    type: "warning",
    ...
    function save_bag(ref) {
        ...
        for(var _tmpBrandId in _brandIdWiseSubTotal)
        {
        ...
        if(_isValidForQuotes == false)
        {
            swal({
                    title: "Note",
                    text: "Please make sure that bag total for following brands satisfies with minimum amount<br>"+_minBrandMsg,
                    type: "warning",
                    confirmButtonText: "OK",
                    closeOnConfirm: false
                });
                ...
                success: function(response) {
                    ...
                    if (typeof response == 'object') {
                        if (response.status == "SUCCESS") {
                            ...
                            text:  "Please remove out of stock products from bag to proceed.",
                            type: "warning",
                            confirmButtonText: "OK",
                            closeOnConfirm: false
                            });
                              return; 
                        }else if(response.status == 'Deactivated_Product'){
    ...
    function tempSaveBag(ref) {
        ...
        if(_isValidForQuotes == false)
        {
            swal({
                    title: "Note",
                    text: "Please make sure bag total for following brands satisfies with minimum amount<br>"+_minBrandMsg,
                    type: "warning",
                    confirmButtonText: "OK",
                    closeOnConfirm: false
                });
        ...
        {
            var url = SITE_URL+'/retailer/set_session';
            var bag_data = $("#frm-apply-quotes").serialize();
            var wholesale_total = $('#wholesale_total').text();
...
function applyPromoCode(maker_id)
{
    ...
    var url = SITE_URL+'/my_bag/apply_promo_code';
...
{
    var url = SITE_URL+'/my_bag/clear_promo_code';
