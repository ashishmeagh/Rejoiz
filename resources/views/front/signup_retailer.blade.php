...
@php
 $retailer_dummy_store_name = '';
 $retailer_dummy_store_name = get_retailer_dummy_store_name();
...
<div class="login-main-bg-img spacesignups">    
    <div class="login-main-page-dv-hm signupsclasssign signupretailer-images">
        <!-- <div class="banner-block">
            <div class="img-lgn-in space-topsignup">
            <div class="titlelogin-leftside">New retailer account</div>
            <div class="login-welcm">Fill the below form to create a new account.</div>

            {{-- <div class="social-button-main-login">
                <div style="cursor: pointer;"><img onclick="fbLogin()" src="{{ url('/')}}/assets/images/facebook-sign-in-button.png"></div>
                <div id="gSignIn"></div>
            </div> --}}
...
{{--       @include('front.layout.flash_messages')--}}       
         <!-- {{ csrf_field() }} -->
        <div class="login-right-page signup_retailer_page">
           ...
           @endif
            ...
            <div class="welcomebackkadoe">Create Your Customer Account</div>
              ...
              <div class="loginform">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="user-box rw-login-user-box" id="pwd_class">
                  ...
                  <div class="col-md-6">
                    <div class="user-box">
                      ...
                      data-parsley-pattern-message="Please enter valid mobile number."  data-parsley-type-message="Please enter valid mobile no." {{-- data-parsley-minlength-message="Mobile No should be of 10 digits."  data-parsley-maxlength="1" --}} data-parsley-maxlength-message="Mobile No must be less than 14 digits."/>
                  ...
                  <div class="col-md-6">
                    <div class="user-box" id="store_name_container">
                        ...
                        <input class="cont-frm" placeholder="Enter Your Store Name" type="text" name="store_name" id="store_name"
                         data-parsley-required="true" data-parsley-required-message="Please enter store name."/>
                      </div>
                  </div>

                   <div class="col-md-6">
                    <div class="user-box" id="dummy_store_name_container">
                        <label class="form-lable">Rejoiz Store Name<i class="red">*</i></label>
                        <input class="cont-frm" placeholder="Enter Your Rejoiz Store Name" type="text" name="dummy_store_name" id="dummy_store_name"
                         data-parsley-required="true" data-parsley-required-message="Please Enter Rejoiz Store Name." value="{{$retailer_dummy_store_name}}" readonly style="background-color: #eee;" />
                      </div>
                  </div>
                </div>
                 ...
                 <div class="row1">
                  <div class="col-md-6">
                   ...
                   <div class="col-md-6">
                    <div class="user-box">
                        <label class="form-lable">Category<i class="red">*</i></label>
                        <select name="category" id="category" data-parsley-required="true" data-parsley-required-message="Please select category.">
                        ...
                        @if(isset($category_arr) && count($category_arr)>0)
                          ...
                          @foreach($category_arr  as $key=>$category)
                           ...
                           <option value="{{$category['id']}}">{{isset($category['category_name'])?$category['category_name']:''}}</option>
                  ...
                  <div class="row">
                    <div id="store_data_container" style="display:none">
                       <div class="col-md-6">
                            <div class="user-box">
                          <label class="form-lable">Years in business</label>
                  ...
                  <div class="row">
                  <div class="col-md-6" id=store_website_container style="display:none">
                   
                      <div class="user-box">
                        <label class="form-lable">Store Website</label>
                  ...
                  <div class="col-md-6" id="pop_up_data_container" style="display:none">
                    
                     <div class="user-box">
                       <label class="form-lable">Zip/Postal Code</label>
                        <input class="cont-frm" oninput="this.value = this.value.toUpperCase()" placeholder="Zip Code" type="text" name="zip_code" id="pop_up_zip_code" data-parsley-trigger="change"/>
                      <div id="err_zip_code"></div>
                      </div> 
                    
                  </div>
                  <div class="col-md-6" id ="store_description_container" style="display:none">
                   
                      <div class="user-box">
                       <label class="form-lable">Store Description</label>
 ...
 $('#btn_signup').click(function()
  {
      ...
      { 
         $("#err_zip_code").html('Please enter zip/postal code.');
      }
      else if(country_code=="" && zip_code!="")
      { 
...
function retailerStore(ref)
{
  ...
  else if(selected_value == 3)
  {
      ...
      if(zipcode_length == 8)
      {
          $('#pop_up_zip_code').attr('parsley-maxlength', true);
          $('#pop_up_zip_code').removeAttr('data-parsley-length');
          $('#pop_up_zip_code').attr('data-parsley-length-message', "");
          $("#pop_up_zip_code").attr({
          ...
          $('#pop_up_zip_code').attr('parsley-maxlength', false);
          $('#pop_up_zip_code').attr('data-parsley-maxlength-message', "");
          $("#pop_up_zip_code").attr({
  ...
  else
  {
      ...
      /* Commented by Bhavana, Confirm with Mona (START)*/
      // $("#store_name").attr("data-parsley-required","true");
      // $("#store_name").attr("data-parsley-required-message","Please enter store name.");
      ...
      /* Commented by Bhavana, Confirm with Mona (END)*/

    /*  $("#years_in_business").removeAttr('data-parsley-required');
      $("#pop_up_zip_code").attr("data-parsley-required","true");
      $("#store_website").removeAttr('data-parsley-required');*/

      //if out of three option none of these then hide all fields and their required validation

      $("#years_in_business").removeAttr('data-parsley-required');
      $("#store_description").removeAttr('data-parsley-required');
      $("#store_website").removeAttr('data-parsley-required');
      $("#pop_up_zip_code").removeAttr('data-parsley-required');
      // $("#store_name").removeAttr("data-parsley-required","true");
