              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div @if(Session::has('representative_order_id')==true) class="point-event-on point-event-d" @else class="point-event-on" @endif>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="user-box space-b-o">
                          <label class="form-lable" for="name">Street Address</label>
                          <input type="text" placeholder="Street Address" class="cont-frm text-checkout" name="shipping_addr" id="shipping_addr" value="{{$customer_shipping_addr['shipping_addr']}}" data-parsley-required="true" data-parsley-required-message="Please enter street address.">
                        </div>
                      </div>
                      ...
                      <div class="col-md-12">
                        <div class="user-box space-b-o">
                          ...
                          <input type="text" placeholder="Suit/Apt" class="cont-frm text-checkout" name="shipping_suit_apt" id="shipping_suit_apt" value="{{$customer_shipping_addr['shipping_suit_apt'] or ''}}">
                        </div>
                      </div>

                      <div class="col-md-6">
                        <div class="user-box space-b-o">
                          <label class="form-lable" for="name">City</label>
                          <input type="text" placeholder="City" class="cont-frm" name="shipping_city" id="shipping_city" value="{{$customer_shipping_addr['shipping_city'] }}" data-parsley-required="true" data-parsley-required-message="Please enter city.">
                        </div>
                      </div>

                      <div class="col-md-6">
                        <div class="user-box space-b-o">
                          <label class="form-lable" for="name">State</label>
                          <input type="text" placeholder="State" class="cont-frm" name="shipping_state" id="shipping_state" value="{{$customer_shipping_addr['shipping_state'] }}" data-parsley-required="true" data-parsley-required-message="Please enter state.">
                        </div>
                      </div>
                      ...
                      <div class="col-md-12">
                        <div class="user-box space-b-o">
                          <label class="form-lable" for="name">Country</label>
                          <select class="form-control" id="shipping_country" name="shipping_country" data-parsley-required="true" data-parsley-required-message="Please select country.">
                            ...
                            <option value="{{$country['id']}}" @if($country['id']==$customer_shipping_addr['shipping_country']) selected @endif phone_code="{{$country['phonecode'] or ''}}" zipcode_length="{{ $country['zipcode_length'] or '' }}" country_name="{{ $country['name'] or '' }}">{{$country['name']}}</option>
                            @endforeach
                            @endif
                          </select>
                        </div>
                      ...
                      <div class="col-md-6">
                        <div class="user-box space-b-o">
                          <label class="form-lable" for="ship_contact_no">Mobile No</label>
                          <input type="text" name="ship_contact_no" class="form-control" data-parsley-required="true" data-parsley-required-message="Please enter mobile number." placeholder="Mobile No." id="ship_contact_no" value="{{$customer_shipping_addr['ship_contact_no'] or ''}}" data-parsley-maxlength="18" data-parsley-maxlength-message="Mobile No must be less than 18 digits." data-parsley-pattern="^[0-9*#+]+$" data-parsley-required data-parsley-pattern-message="Please enter valid mobile number." data-parsley-minlength-message="Mobile No should be of 10 digits.">
                      ...
                      <div class="col-md-6">
                        <div class="user-box space-b-o">
                          <label class="form-lable" for="name">Zip/Postal Code</label>
                          <input oninput="this.value = this.value.toUpperCase()" type="text" name="shipping_zip_postal_code" class="cont-frm" placeholder="Zip Code" id="shipping_zip_postal_code" value="{{ $customer_shipping_addr['shipping_zip_postal_code']}}" data-parsley-required="true" data-parsley-required-message="Please enter zip/postal code." data-parsley-trigger="change">                          
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="user-box space-b-o same_shipping_address">
                      ...
                      <div class="col-md-12">
                        <div class="user-box space-b-o">
                          <label class="form-lable" for="name">Street Address</label>
                          <input type="text" placeholder="Street Address" class="cont-frm text-checkout" name="billing_addr" value="{{$customer_billing_addr['billing_addr']}}" id="billing_addr" data-parsley-required="true" data-parsley-required-message="Please enter street address.">
                        </div>
                      </div>
                      ...
                      <div class="col-md-12">
                        <div class="user-box space-b-o">
                          ...
                          <input type="text" placeholder="Suit/Apt" class="cont-frm text-checkout" name="billing_suit_apt" id="billing_suit_apt" value="{{$customer_billing_addr['billing_suit_apt'] or ''}}">
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="user-box space-b-o">
                          <label class="form-lable" for="name">City</label>
                          <input type="text" placeholder="City" class="cont-frm" name="billing_city" id="billing_city" value="{{ $customer_billing_addr['billing_city']}}" data-parsley-required="true" data-parsley-required-message="Please enter city.">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="user-box space-b-o">
                          <label class="form-lable" for="name">State</label>
                          <input type="text" placeholder="State" class="cont-frm" name="billing_state" id="billing_state" value="{{ $customer_billing_addr['billing_state']}}" data-parsley-required="true" data-parsley-required-message="Please enter state.">
                        </div>
                      </div>
                      ...
                      <div class="col-md-12">
                        <div class="user-box space-b-o">
                          ...
                          <select class="form-control" id="billing_country" name="billing_country" data-parsley-required="true" data-parsley-required-message="Please select country.">
                            ...
                            @if(isset($country_data) && count($country_data)>0)
                            @foreach($country_data as $key=>$country)
                            <option value="{{$country['id']}}" @if($country['id']==$customer_billing_addr['billing_country']) selected @endif phone_code="{{$country['phonecode'] or ''}}" zipcode_length="{{ $country['zipcode_length'] or '' }}" country_name="{{ $country['name'] or '' }}">{{$country['name']}}</option>
                            @endforeach
                            @endif
                          </select>
                        </div>
                      ...
                      <div class="col-md-6">
                        <div class="user-box space-b-o">
                          <label class="form-lable" for="bill_contact_no">Mobile No</label>
                          <input type="text" name="bill_contact_no" class="form-control" data-parsley-required="true" data-parsley-required-message="Please enter mobile number." placeholder="Mobile No." id="bill_contact_no" value="{{$customer_billing_addr['bill_contact_no'] or ''}}" data-parsley-pattern="^[0-9*#+]+$" data-parsley-required data-parsley-pattern-message="Please enter valid mobile number." data-parsley-maxlength="18" data-parsley-maxlength-message="Mobile No must be less than 18 digits." data-parsley-minlength="10" data-parsley-minlength-message="Mobile No should be of 10 digits.">
                      ...
                      <div class="col-md-6">
                        <div class="user-box space-b-o">
                          <label class="form-lable" for="name">Zip/Postal Code</label>
                          <input oninput="this.value = this.value.toUpperCase()" type="text" name="billing_zip_postal_code" id="billing_zip_postal_code" class="form-control" placeholder="Zip Code" data-parsley-required="true" data-parsley-required-message="Please enter zip/postal code." data-parsley-trigger="change" value="{{$customer_billing_addr['billing_zip_postal_code']}}">
                  ...
                  <div class="demo-container checkoutside">
                    ...
                    <div class="form-container active checkout-forms">
                      ...
                      <div class="user-box">
                        ...
                        {{-- <input autocomplete='off' class='form-control card-number' type='tel' name="number" data-parsley-required="true" data-parsley-creditcard="true" id="card_no" placeholder="Enter card number"> --}}
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="user-box">
                            <input type="text" name="expiry" data-parsley-required="true" data-parsley-required-message="Please enter card expiry date." class="form-control" data-date-format="MM/YYYY" id="expiry" placeholder="MM / YYYY"> {{-- disabled --}}
                          </div>
                        </div>
  ...
  <div class="theiaStickySidebar">
    ...
    <div class="bag-details">
      ...
      <div class="innerbag-details">
        @php
        $shipping_charges = $repPanelShipDiscount = $_grandAmount = $total_ship_discount_value = $total_product_dis_value = 0;
        $_subTotal = $_prodDiscount = $_shippingCharges = $_shipDiscount = 0;


        $total_ship_discount_value_perc = $total_ship_discount_value_dollar = $total_product_dis_value_perc = $total_product_dis_value_dollar = 0;
        ...
        /*$promo_shipping_charges = isset($session_promotion_data[$key]['final_total'][$key]['shipping_charges'])?$session_promotion_data[$key]['final_total'][$key]['shipping_charges']:0;*/
        ...
        if(isset($arr_product_data['prodduct_dis_type']) && $arr_product_data['prodduct_dis_type'] == 2)
        {
        ...
        elseif (isset($arr_product_data['prodduct_dis_type']) && $arr_product_data['prodduct_dis_type'] == 1)
        {
    ...
    <div class="price-det-block">
      ...
      // $orderCalculationData['grand_total'] = $orderCalculationData['grand_total']-$promo_discount_amt;
      }
      ...
      <div class="order-sum">
        ...
        {{-- @if(isset($orderCalculationData['promotion_shipping_charges']) && $orderCalculationData['promotion_shipping_charges'] > 0)
               ...
               <div class="mybag-list">
                  <div class="mybag-list-left">Free shipping Amount : </div>
                  <div class="mybag-list-right">@if($orderCalculationData['promotion_shipping_charges']>0)-@endif${{num_format($orderCalculationData['promotion_shipping_charges'])}}
      </div>
...
<script>
  ...
  $(document).ready(function() {
    ...
    if ((get_shipping_addr === get_billing_addr) && (get_shipping_city === get_billing_city) && (get_shipping_state === get_billing_state) && (get_shipping_zip_code === get_billing_zip_code) && (get_shipping_country === get_billing_country)) {
    ...
    $('#btn_pay').click(function() {
      ...
      if (ship_streeAddr == '' && ship_city == '' && ship_state == '' && ship_country == '' &&
        ship_zipcode == '' && bill_streeAddr == '' && bill_city == '' && bill_state == '' && bill_country == '' &&
        bill_zipcode == '') {
          ...
          swal({
            ...
            function() {
              if (representative_order_id != '') {
                location.href = '{{url('/customer/my_orders/order_from_representative')}}';
              } else {
                location.href = '{{url('/customer/my_orders')}}';
              }
