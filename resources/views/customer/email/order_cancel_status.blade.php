                     ...
                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                           <td>
                              ...
                              <p>Order No: {{$order_details['order_no']}}, Vendor has approved your cancel order request.</p> 

                              @elseif($status == 0)

                              <p>Order No: {{$order_details['order_no']}}, Vendor has rejected your cancel order request.</p>
