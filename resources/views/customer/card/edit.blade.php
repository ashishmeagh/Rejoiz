                        ...
                        <div class="form-container active" >
                           <form id="frm-card" method="post">
                            ...
                            -->
                              ...
                              <input type="text" name="expiry" data-parsley-required="true" data-parsley-required-message="Please enter card expiry date" class="form-control" data-date-format="mm/dd/yyyy" id="expiry" placeholder="MM / YYYY" value="{{$card_expiry or ''}}">
...
<script>
  ...
  $('#frm-card').card({
   ...
   $('#btn_update').click(function()
   {
     ...
     var url       = "{{url('/'.config('app.project.customer_panel_slug'))}}/card/update";    
