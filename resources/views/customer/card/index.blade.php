                     ...
                     <tbody>
                       ...
                       @if(isset($arr_card_details) && count($arr_card_details) > 0)
                          ...
                          <tr>
                            ...
                            {{--  <a href="javascript:void(0)" attr-href="{{$module_url_path}}/delete/{{base64_encode($card['stripe_card_id'])}}/{{base64_encode($card['customer_id'])}}" class="btn btn-outline btn-info btn-circle show-tooltip  btn-customer-view deletestyle" title="Delete Card Details" onclick=" return deleteCard(this);">Delete </a>  --}}

                            <a href="javascript:void(0)" attr-href="{{$module_url_path}}/delete/{{base64_encode($card['stripe_card_id'])}}/{{base64_encode($card['customer_id'])}}/{{base64_encode($card['fingerprint'])}}" class="btn btn-outline btn-info btn-circle show-tooltip  btn-customer-view deletestyle" title="Delete Card Details" onclick=" return deleteCard(this);">Delete </a>
