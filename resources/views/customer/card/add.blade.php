                           ...
                           <form id="frm-card" method="post">
                            ...
                            <!--  <input type="text" name="expiry" data-parsley-required="true" placeholder="MM / YYYY"  id="expiry" class="form-control"/> 
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-6">
                                  <input type="password" name="cvc" class="form-control" data-parsley-required="true" data-parsley-required-message="Please enter CVV number" placeholder="CVV" maxlength="4" class="form-control" onkeypress="return isNumber(event)"/>
                                </div>
                              </div>                       
...
<script>
   ...
   $('#btn_add').click(function()
   {
     ...
     var url       = "{{url('/'.config('app.project.customer_panel_slug'))}}/card/store";    
