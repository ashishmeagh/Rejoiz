    ...
    'data': function(d)
      ...
      
     {
         ...
         { 
           ...
           {
             return `<input type="checkbox" checked data-size="small" class="js-switch" onchange='changeAprovalStatus(`+row.id+`,$(this))' data-color="#99d683" data-secondary-color="#f96262" />`
           }
           else
           {
             return `<input type="checkbox" data-size="small" class="js-switch" onchange='changeAprovalStatus(`+row.id+`,$(this))' data-color="#99d683" data-secondary-color="#f96262" />`
           }
         },
         "orderable": false,
         "searchable":false
