     <!-- /.container-fluid -->
    <footer class="footer text-center">  <i class="fa fa-copyright"></i> <a href="{{url('/')}}">{{isset($site_setting_arr['site_name'])?$site_setting_arr['site_name']:'Rwaltz'}}</a> {{date('Y')}}. All Rights Reserved.</footer>
