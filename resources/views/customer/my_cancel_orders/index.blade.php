...
<style type="text/css">
  .maker_data_filter_row .parsley-errors-list.filled {position:inherit;}
                 ...
                 <form class="form-horizontal" id="report_form">
                    <div class="form-group row maker_data_filter_row">
                      <div class="maker_data_filter_input mr-2">
                        <label class="label-float" for="order_from_date">Order From Date</label>
                     ...
                     <div class="maker_data_filter_input">
                      <label class="label-float" for="order_to_date">Order To Date</label>
