...
<div class="row bg-title">
   ...
   <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
      <ol class="breadcrumb">
         <li><a href="{{url('/')}}/{{ $representative_panel_slug }}/dashboard">Dashboard</a></li>
         ...
         <div class="row">
            <div class="col-sm-12 col-xs-12">
               ...
               <div class="form-group row">
                  <label class="col-sm-12 col-md-12 col-lg-3 col-form-label">Current Password<i class="red">*</i></label>
               ...
               <div class="form-group row">
                  <label class="col-sm-12 col-md-12 col-lg-3 col-form-label">New Password<i class="red">*</i></label>
                  <div class="col-sm-12 col-md-12 col-lg-9">
               ...
               <div class="form-group row">
                  ...
                  <label class="col-sm-12 col-md-12 col-lg-3 col-form-label">Confirm Password<i class="red">*</i></label>
                  <div class="col-sm-12 col-md-12 col-lg-9">
               ...
               <div class="form-group row">
                  <div class="col-12">
                      <a class="btn btn-inverse waves-effect waves-light pull-left" href="{{url('/')}}/{{ $representative_panel_slug }}/dashboard"><i class="fa fa-arrow-left"></i> Back</a>
