...
/* .ctomr-shipping-details.space-retailer.spacetp-retailerbill{
  margin-top: 48px;
} */
.bottom-30{margin-bottom: 55px;}
                      ...
                      @if(isset($arr_data['order_details']) && sizeof($arr_data['order_details'])>0) 
                        @foreach($product_data as $key=> $products)
                          @php 
                              ...
                              $maker_brand_name = get_maker_company_name($key);
                          @endphp
                          <div class="bag-clone-group">
                            <div class="jst-mybg">
                                  {{-- <div class="brand-name-title spc-top" data-brand="{{$key}}" data-brand-min="{{num_format($maker_min_order_amount)}}">{{get_maker_company_name($key)}}</div> --}}
                                  <div class="creativebtdstitlte">{{ $maker_brand_name }}</div>
                            ...
                            @if($key == $product['maker_id'])
                              <div class="brand-dtls-nw save-itlater-bx">
                                ...
                                <div class="brnd-dtls-mn">
                                  ...
                                  <input type="hidden"  class = "shipping_charge" name="shipping_charge" value="{{isset($shipping_charge)?$shipping_charge:0}}">
                                  <input type="hidden"  class = "shipping_charge" name="shipping_discount" value="{{isset($shipping_discount)?$shipping_discount:0}}">
                                  <input type="hidden"  class = "shipping_charge" name="shipping_type" value="{{$shipping_type}}">
                                  ...
                                  <div class="price-bnd-dtls">
                                    SKU No : <span class="bold-tx-ordr">{{$product['sku'] or 'N/A'}}</span>
                                  </div>
                                 ...
                                 @if(isset($product['product_details']['product_discount']) && $product['product_details']['product_discount']!=0)
                                    ...
                                    <div class="inpt-selects">
                                       {{-- <div class="price-bnd-dtls">Product Discount {{$type or ''}}:
                                          <span class="price-bnd-dtls">${{isset($product['product_discount'])?num_format($product['product_discount']) : 0}}</span>
                                        </div> --}}
                                ...
                                @if(isset($product['product_details']['off_type_amount']) && 
                                    ...
                                    <div class="inpt-selects">
                                        {{-- <div class="price-bnd-dtls">Shipping Discount {{$ship_type or ''}}:
                                          <span class="price-bnd-dtls">${{isset($product['shipping_charges_discount'])?num_format($product['shipping_charges_discount']) : 0}}</span>
                                        </div> --}}
                      ...
                      <div class="row minusrow">    
                        <div class="col-xs-12 col-sm-12 col-md- col-lg-6 order_summary">
                          ...
                          @endphp
                            ...
                            <div class="ctomr-shipping-details space-retailer spacetp-retailerbill bottom-30"> Customer Shipping Details:</div>

                            {{-- <div style="height: 50px;"></div> --}}
                           @php

                              $fname = isset($arr_data['address_details']['ship_first_name'])?$arr_data['address_details']['ship_first_name']:'';

                              $lname = isset($arr_data['address_details']['ship_last_name'])?$arr_data['address_details']['ship_last_name']:'';
                          ...
                          <div class="postion-re">
                            ...
                            <div class="postion-reright">
                              <input type="input" name="ship_name" id="ship_name" class="form-control"  value="{{$name or ''}}" readonly="">
                            </div>
                            <div class="clearfix"> </div>
                          </div>
                          ...
                          <div class="postion-re">
                              ...
                              <div class="postion-reright">
                                  <input type="input" name="ship_email" id="ship_email" readonly="" class="form-control" value="{{isset($arr_data['address_details']['ship_email'])?$arr_data['address_details']['ship_email']:''}}">
                              </div>
                              <div class="clearfix"> </div>
                          </div>
                          ...
                          <div class="postion-re">
                              ...
                              <div class="postion-reright">
                                ...
                                <input type="input" name="ship_complete_addr" id="ship_complete_addr" class="form-control is-read-only" value="{{$arr_data['address_details']['ship_complete_address']}}" data-parsley-required="true" data-parsley-required-message="Please enter address">
                              </div> --}}
                          ...
                          <div class="postion-re">
                              ...
                              <div class="postion-reright">
                                  <input type="input" name="ship_city" id="ship_city" class="form-control is-read-only" value="{{isset($arr_data['address_details']['ship_city'])?$arr_data['address_details']['ship_city']:''}}" data-parsley-required="true" data-parsley-required-message="Please enter city" data-parsley-pattern="^[a-zA-Z ]+$" data-parsley-pattern-message="Only alphabets are allowed">
                              </div>
                              <div class="clearfix"> </div>
                          </div>
                                ...
                                <select class="form-control" id="ship_country" name="ship_country" data-parsley-required="true" data-parsley-required-message="Please select country" placeholder="Select Country">
                                  <option value="">Select Country</option>
                                    @if(isset($country_arr) && count($country_arr)>0)
                                      ...
                                      <option @if(isset($arr_data['address_details']['ship_country']) && $arr_data['address_details']['ship_country']==$country['id']) selected="selected" @endif phone_code="{{$country['phonecode'] or ''}}" zipcode_length="{{ $country['zipcode_length'] or '' }}" country_name="{{ $country['name'] or '' }}" value="{{$country['id']}}">{{$country['name']}}</option>
                          ...
                          <div class="postion-re">
                            ...
                            <div class="postion-reright">
                               <input type="input" name="ship_mobile_no" id="ship_mobile_no" class="form-control is-read-only" data-parsley-pattern="^[0-9*#+]+$" data-parsley-required data-parsley-pattern-message="Please enter valid mobile number" data-parsley-minlength-message="Mobile number should be 10 digits" data-parsley-maxlength="18" data-parsley-maxlength-message="Mobile number must be less than 18 digits" data-parsley-required="true" data-parsley-required-message="Please enter mobile number" value="{{isset($arr_data['address_details']['ship_mobile_no'])?$arr_data['address_details']['ship_mobile_no']:''}}">
                          ...
                          <div class="form-group">
                            ...
                            <div class="postion-re spacetopmargn">
                              ...
                              <div class="postion-reright">
                                ...
                                @endphp
                                <input type="input" name="bill_name" readonly="" id="bill_name" class="form-control" value="{{isset($user_name)?$user_name:''}}">
                              </div>
                            ...
                            <div class="postion-re">
                              <div class="postion-re-left">Email</div>
                              <div class="postion-reright">
                              <input type="input" name="bill_email" id="bill_email" readonly="" class="form-control" value="{{isset($arr_data['address_details']['bill_email'])?$arr_data['address_details']['bill_email']:''}}"></div>
                            </div>
                            <div class="clearfix"> </div>                            
                            ...
                            <div class="postion-re">
                              {{-- <div class="postion-re-left">Address</div>
                              <div class="postion-reright">
                                <input type="input" name="bill_complete_addr" id="bill_complete_addr" class="form-control is-read-only" value="{{isset($arr_data['address_details']['bill_complete_address'])?$arr_data['address_details']['bill_complete_address']:''}}" data-parsley-required="true" data-parsley-required-message="Please enter address">
                              </div> --}}
                            ...
                            <div class="postion-re">
                              <div class="postion-re-left"> City</div>
                              <div class="postion-reright">
                                <input type="input" name="bill_city" id="bill_city" class="form-control is-read-only" value="{{isset($arr_data['address_details']['bill_city'])?$arr_data['address_details']['bill_city']:''}}" data-parsley-required="true" data-parsley-required-message="Please enter city" data-parsley-pattern="^[a-zA-Z ]+$" data-parsley-pattern-message="Only alphabets are allowed">
                              </div>
                              <div class="clearfix"> </div>
                            </div>
                            ...
                            <div class="postion-re">
                              <div class="postion-re-left">State</div>
                              <div class="postion-reright">
                                 <input type="input" name="bill_state" id="bill_state" class="form-control is-read-only" value="{{isset($arr_data['address_details']['bill_state'])?$arr_data['address_details']['bill_state']:''}}" data-parsley-required="true" data-parsley-required-message="Please enter state" data-parsley-pattern="^[a-zA-Z ]+$" data-parsley-pattern-message="Only alphabets are allowed">
                              </div>
                              <div class="clearfix"> </div>
                            </div>
                                    ...
                                    <div class="postion-reright">
                                        <select class="form-control" id="bill_country" name="bill_country" data-parsley-required="true"  data-parsley-required-message="Please select country" placeholder="Select Country">
                                            ...
                                            @if(isset($country_arr) && count($country_arr)>0)
                                                ...
                                                <option @if(isset($arr_data['address_details']['bill_country']) && $arr_data['address_details']['bill_country']==$country['id']) selected="selected" @endif phone_code="{{$country['phonecode'] or ''}}" zipcode_length="{{ $country['zipcode_length'] or '' }}" country_name="{{ $country['name'] or '' }}" value="{{$country['id']}}">{{$country['name']}}</option>
                            ...
                            <div class="postion-re">
                              <div class="postion-re-left">Mobile No</div>
                              <div class="postion-reright">
                               <input type="input" name="bill_mobile_no" id="bill_mobile_no"  class="form-control is-read-only" data-parsley-minlength-message="Mobile number should be 10 digits" data-parsley-maxlength="18" data-parsley-maxlength-message="Mobile number must be less than 18 digits" data-parsley-required="true" data-parsley-required-message="Please enter mobile number" data-parsley-pattern="^[0-9*#+]+$" data-parsley-required data-parsley-pattern-message="Please enter valid mobile number" value="{{isset($arr_data['address_details']['bill_mobile_no'])?$arr_data['address_details']['bill_mobile_no']:''}}">
                  ...
                  <div class="theiaStickySidebar">
                    <div class="order-summary-main-dv-cs">
                      ...
                      <div class="ordr-total-ship">
                         ...
                         <div class="ordr-total-ship-right">${{isset($Wholsale_sub_total)?num_format($Wholsale_sub_total):0.00}}
                    ...
                    {{--   @if(isset($data['total_product_shipping_charges']) && $data['total_product_shipping_charges'] > 0) --}}
                      ...
                      @if(isset($total_shipping_charges)&& $total_shipping_charges>0)
                        ...
                        <div class="ordr-total-ship">
                          ...
                          <div class="ordr-total-ship-right"> @if(num_format($total_shipping_charges)>0)+@endif${{isset($total_shipping_charges)?num_format($total_shipping_charges):0.00}}
                          </div> --}}
                          <div class="clearfix"></div>
                        </div>
                      @endif
                      ...
                      @php
                       ...
                       if(isset($arr_data['order_details']) && count($arr_data['order_details'])>0)
                       {
                          foreach($arr_data['order_details'] as $key => $product)
                          {
                            //$total_shipping_charges_discount = array_sum($total_shipping_discount);
                      ...
                      @endphp
                       ...
                       @if(isset($total_shipping_charges_discount) && $total_shipping_charges_discount!=0)
                        <div class="ordr-total-ship">
                          ...
                          <div class="ordr-total-ship-right">@if(num_format($total_shipping_charges_discount)>0)-@endif${{isset($total_shipping_charges_discount)?num_format($total_shipping_charges_discount):0}} --}}
                        </div>
                          <div class="clearfix"></div>
                        </div>
                      @endif
                      ...
                      @endphp
                         ...
                         @if(isset($total_product_discount) && $total_product_discount > 0)
                            ...
                            <div class="ordr-total-ship-right">@if(num_format($total_product_discount)>0)-@endif ${{isset($total_product_discount)?num_format($total_product_discount):0}} --}}
                            </div>
                              <div class="clearfix"></div>
                            </div>
                            @endif
                       ...
                       <div class="ordr-total-ship">
                         ...
                         <div class="ordr-total-ship-right"> $
                          ...
                          @php 
                           ...
                           $total_amount = $Wholsale_sub_total+$total_shipping_charges-$total_product_discount-$total_shipping_charges_discount;
  ...
  jQuery(document).ready(function(e){     
    ...
    $("#ship_country").change(function(){
      ...
      var post_code = $("#ship_zip_code").val();
        ...
        var phone_code = $('option:selected', "#ship_country").attr('phone_code');
        var zipcode_length = $('option:selected', "#ship_country").attr('zipcode_length');
        var countryName = $('option:selected', "#ship_country").attr('country_name');
    ...
    $("#bill_country").change(function(){
      ...
      var phone_code = $('option:selected', "#bill_country").attr('phone_code');
      var zipcode_length = $('option:selected', "#bill_country").attr('zipcode_length');
      var countryName = $('option:selected', "#bill_country").attr('country_name');
...
{ 
  ...
  if(_isValidForQuotes == false)
  {
    ...
    /*$('#btn_confirm').on('click',function(){*/
     ...
     swal({
      title: "Need Confirmation",
      text: "Are you sure? Do you want to confirm this order, after confirming you will not able to modify anything.",
      type: "warning",
      showCancelButton: true,
      confirmButtonColor: '#DD6B55',
      confirmButtonText: 'OK',
     ...
     function(isConfirm){
       ...
       { 
            ...
            $.ajax({
                url : '{{url('/')}}/representative/leads/save_address',
                method: 'POST',
                dataType:'JSON',
                data: {
                        "_token": "{{ csrf_token() }}",
