...
@php
    ...
    // Newly added code on date 13 oct 2020
            ...
            <tr>
                <td colspan="2">
                    <table bgcolor="#fff" width="100%" border="0" cellspacing="10" cellpadding="0">
                        <tr>
                            <td width="40%" style="font-size:40px; color: #fff;"><img src="{{$site_logo}}" width="150px" alt="{{ $site_name }}"/></td>
                    ...
                    <table width="100%">
                        <tbody>
                            ...
                            @php
                              ...
                              $first_name = $last_name = $email = $country_id = $post_code = $user_name = '';
 ...
 --}}
                            ...
                            @endif 
                                ...
                                <td width="30%" style="font-size:12px; text-align: left;"> <h3 style="margin-bottom: 5px;">Order To (Retailer) :</h3>
                                   ...
                                   @php
                                     $store_name = $address2 = $address = $city = $state = $country = $post_code = '';

                                     $store_name = isset($retailer_data['shop_name'])&&$retailer_data['shop_name']!=''?$retailer_data['shop_name']:'';


                                     if(isset($hide_retailer_name) && $hide_retailer_name != 1){ 
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <?php
                                ...
                                $tot_sub_total = ($ord['qty']*$ord['unit_wholsale_price']);
                            ...
                            <td style="border-bottom: 1px solid #e5e9f1;font-size:12px;text-align: left;padding:12px 12px 12px 30px;">${{$tot_sub_total or 0}}</td>
