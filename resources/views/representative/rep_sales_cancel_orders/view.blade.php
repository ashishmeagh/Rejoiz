...
<div class="row">
         ...
         <div class="row">
            ...
            <div class="col-sm-6">
               ...
               <div class="row">
                ...
                @endif
               <div class="row">
                  <label class="col-sm-4"><span class="sanssemibold">Payment Status</span></label>
                  <div class="col-sm-8">
                     <span>
                     @if($payment_status == 2) 
            ...
            <table class="table table-striped table-bordered view-porifile-table">
               ...
               <tr>
                 ...
                 {{--  @if(isset($lead['product_details']['description']) && strlen($lead['product_details']['description']) > 70)
                  ...
                  <td class="summmarytdsprice"><span class="fa fa-dollar"></span>{{$lead['product_details']['unit_wholsale_price'] or 'N/A' }}
                  ...
                  <td>@if($lead['product_discount']>0)-@endif<span class="fa fa-dollar"></span>{{isset($lead['product_discount'])?num_format($lead['product_discount']):0.00}}
   ...
   <div class="col-md-12">
      <div class="form-group row">
         <div>
               <a class="btn btn-success pull-rightbtn-rounded btn-outline waves-effect waves-light pull-left" href="{{URL::previous()}}"><i class="fa fa-arrow-left"></i> Back</a>
         </div>
      </div>
   </div>
</div>
