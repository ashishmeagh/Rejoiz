...
<div class="row bg-title">
   ...
   <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
      <ol class="breadcrumb">
          ...
          <li><a href="{{ $module_url_path or '' }}">Leads</a></li>
                        ...
                        <div class="chat-left-inner">
                          <div class="user-profile-chat-main left-mkr-chat">
                            <div class="user-profile-chat">
                              <img alt="male" id="representative-prof-img" src="{{ getProfileImage($lead_arr['representative_user_details']['profile_image']) }}" height="100px" width="100px">
                            </div>
                            <div class="user-profile-chat-txt">{{ $lead_arr['representative_user_details']['first_name'].' '.$lead_arr['representative_user_details']['last_name']}} </div>                             
                             <div class="price-quote">$ {{ $lead_arr['total_retail_price'] or ''}}</div>
                          </div>
                    ...
                    <div class="chat-right-aside">
                        <div class="chat-main-header">
                               <div class="quote-cnvrttion"><span id="chat-title">Chat Details</span>
                                ...
                                @if(check_is_user_online($lead_arr['maker_id']))
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-6">
                                      <div class="table-style-mkr">
                                        ...
                                        <div class="enquiry-id-right">{{ $lead_arr['user_details']['first_name'] or '' }} {{ $lead_arr['user_details']['last_name'] or '' }}</div>
                                        <div class="clearfix"></div>
                                      </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                      <div class="table-style-mkr">
                                        ...
                                        <div class="enquiry-id-right">{{ $lead_arr['retailer_user_details']['first_name'] or '' }} {{ $lead_arr['retailer_user_details']['last_name'] or '' }}</div>
                                        <div class="clearfix"></div>
                                      </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                      <div class="table-style-mkr">
                                        ...
                                        <div class="enquiry-id-right">{{ $lead_arr['maker_details']['brand_name'] or '' }}</div>
                                        <div class="clearfix"></div>
                                      </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                      <div class="table-style-mkr">
                                        ...
                                        <div class="enquiry-id-right">$ {{ $lead_arr['total_retail_price'] or '' }}</div>
                                        <div class="clearfix"></div>
                                      </div>
                                    </div>
                                  </div>
                                ...
                                <div class="col-sm-12">
                                  <form id="chat-frm">
                                    {{ csrf_field() }}                                     
                                     ...
                                     <input type="hidden" name="receiver_id" id="receiver_id" value="{{ $lead_arr['maker_id'] or '' }}"> 
