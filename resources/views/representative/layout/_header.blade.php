...
<head>
   ...
   @if(isset($site_setting_arr['favicon']))
    ...
    <!-- Custom CSS -->
    <link href="{{url('/')}}/assets/css/style-representative.css" rel="stylesheet">
    <!-- color CSS -->
    <link href="{{url('/')}}/assets/css/colors/blue-representative.css" id="theme" rel="stylesheet">
    <link href="{{url('/')}}/assets/css/just-got-representative.css"rel="stylesheet">
    ...
    @if(Request::segment(3) == 'get_product_details')
