      ...
      <div class="white-box small-space-nw">
         ...
         <div class="row">
            ...
            @if($payment_status == 1)      
              ...
              <div class="row">
                 <label class="col-sm-4">Refund Status</label>
                 <div class="col-sm-8">
                   <?php
             ...
             @endif
              ...
              <div class="row">
                  <label class="col-sm-4"><span class="col-left-vw">Order Status</span></label>
                  <div class="col-sm-8">
         ...
         <div class="table-responsive">
            <table class="table table-striped table-bordered view-porifile-table">
               ...
               <tr>
                  ...
                  <td class="summmarytdsprice"><span class="fa fa-dollar"></span>{{$lead['unit_wholsale_price'] or 'N/A' }}</td>
