         ...
         <div class="row">
            <div class="col-sm-12 col-xs-12">
               ...
               <div class="form-group row">
                  <label class="col-sm-12 col-md-12 col-lg-2 col-form-label">Current Password<i class="red">*</i></label>
               ...
               <div class="form-group row">
                  <label class="col-sm-12 col-md-12 col-lg-2 col-form-label">New Password<i class="red">*</i></label>
                  <div class="col-sm-12 col-md-12 col-lg-10">
               ...
               <div class="form-group row">
                  <label class="col-sm-12 col-md-12 col-lg-2 col-form-label">Confirm Password<i class="red">*</i></label>
                  <div class="col-sm-12 col-md-12 col-lg-10">
