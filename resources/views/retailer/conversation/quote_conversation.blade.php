...
<div class="row bg-title">
   ...
   <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
      <ol class="breadcrumb">
          ...
          <li><a href="{{ $module_url_path }}">My Quote</a></li>
                    ...
                    <div class="chat-left-aside">
                      <div class="open-panel"><i class="ti-angle-right"></i></div>
                        <div class="chat-left-inner">                          
                          <div class="user-profile-chat-main left-mkr-chat">
                            
          
                            <div class="user-profile-chat">
                              <img alt="male" src="{{ getProfileImage($quote_arr['maker_details']['profile_image']) }}">
                            </div>

                            <div class="user-profile-chat-txt"> 
                              {{ $quote_arr['maker_details']['first_name'].' '.$quote_arr['maker_details']['last_name']}} 
                            </div>
                             <div class="brand-nm-ct">{{ $quote_arr['maker_brand_details']['brand_name'] or ''}}</div>                                                         
                          </div>
                    ...
                    <div class="chat-right-aside">
                        <div class="chat-main-header">
                               <div class="quote-cnvrttion"><span id="chat-title">Chat Details</span>
                                @if(check_is_user_online($quote_arr['maker_id']))
                                <span class="badge badge-success">Online</span>
                                @else
                                <span class="badge badge-warning">Offline</span>
                                @endif

                                <a href="javascript:void(0)" class="qute-constn-link" id="quote-details-btn">View Quotes Details </a>
                               </div>
                                <div class="main-quote-dtls" id="quote-details" style="display: none;">
                                  <div class="row">
                                    <div class="col-md-6">
                                      <div class="table-style-mkr">
                                        <div class="enquiry-id-left">Quote ID</div>
                                        <div class="enquiry-id-right">{{ $quote_arr['id'] or '' }}</div>
                                        <div class="clearfix"></div>
                                      </div>
                                    </div>
                                    <div class="col-md-6">
                                      <div class="table-style-mkr">
                                        <div class="enquiry-id-left">Brand Name</div>
                                        <div class="enquiry-id-right">{{ $quote_arr['maker_brand_details']['brand_name'] or '' }}</div>
                                        <div class="clearfix"></div>
                                      </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                      <div class="table-style-mkr">
                                        <div class="enquiry-id-left">Maker Name</div>
                                        <div class="enquiry-id-right">{{ $quote_arr['maker_details']['first_name'] or '' }} {{ $quote_arr['maker_details']['last_name'] or '' }}</div>
                                        <div class="clearfix"></div>
                                      </div>
                                    </div>
                                    <div class="col-md-6">
                                      <div class="table-style-mkr">
                                        <div class="enquiry-id-left">Quote Date</div>
                                        <div class="enquiry-id-right">{{ isset($quote_arr['created_at'])?date('d-M-Y',strtotime($quote_arr['created_at'])):'' }}</div>
                                        <div class="clearfix"></div>
                                      </div>
                                    </div>
                                    <div class="col-md-6">
                                      <div class="table-style-mkr">
                                        ...
                                        <div class="enquiry-id-right">$ {{ $quote_arr['total_retail_price'] or '' }}</div>
                                        <div class="clearfix"></div>
                                      </div>
                                    </div>
                                  </div>
                        ...
                        <div class="chat-box">
                            ...
                            <div class="row send-chat-box">
                                <div class="col-sm-12">
                                  <form id="chat-frm">
                                    {{ csrf_field() }}                                     
                                     <input type="hidden" name="quote_id" id="quote_id" value="{{$quote_arr['id'] or ''}}">      
                                     <input type="hidden" name="receiver_id" id="receiver_id" value="{{ $quote_arr['maker_id'] or '' }}"> 
 ...
 <script type="text/javascript">
                ...
                if(response.status=='SUCCESS'){
                   ...
                   $.each(response.chat_arr,function(index,chat_obj){
                        ...
                        if(chat_obj.sender_details.profile_image==null){
                          ...
                          var profile_img = response.images_public_path+'/'+chat_obj.sender_details.profile_image;                            
                        }
                         ...
                         chat_box = `<li>
                                        ...
                                        <div class="chat-body">
                                            <div class="chat-text">
                                                ...
                                                <p>`+msgContent+`</p> <b>
                                                `+moment(chat_obj.created_at).format("HH:mm A")+`</b> </div>
  ...
  $('#quote-details-btn').click(function(){
    ...
    if($("#quote-details").is(":visible"))
    {
      ...
      $('#quote-details-btn').html('View Quote Details');   
      $('#quote-details').slideUp();
    }
    else
    { 
      $('#chat-title').html('Quote Details');
      $('#quote-details-btn').html('Hide Quote Details');
