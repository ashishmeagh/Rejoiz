...
<style>
    ...
    .total-ttl {margin:0px 0px 15px 0px;}
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-sm-12 main-dash-box white-box">
                        <div class="row row_dash_box">
                            <div class="col-sm-12 total-ttl">
                                <h2>Total Orders: <span><a href="{{url('/')}}/sales_manager/leads">{{ $order_count_arr['total_count'] or '0' }}</a></span></h2>
                            </div>

                            {{-- <div class="col-lg-2 col-sm-6 col-xs-12 dash_box dash_box">
                        <a href="{{url('/')}}/sales_manager/leads">
                        <div class="white-box">
                            <div class="content">
                                <ul class="list-inline two-part">
                                <li class="icon-dashbrds icon-dash-style"><img src="{{url('/assets/front/images/icon-retailer-order.png')}}"></li>
                    ...
                    <div class="col-lg-2 col-sm-6 col-xs-12 dash_box">
                        <a href="{{url('/')}}/sales_manager/leads/pending_orders">
                        <div class="white-box">
                            <div class="content">
                                <ul class="list-inline two-part">
                    ...
                    <div class="col-lg-2 col-sm-6 col-xs-12 dash_box">
                        <a href="{{url('/')}}/sales_manager/leads/completed_orders">
                        <div class="white-box">
                            <div class="content">
                                <ul class="list-inline two-part">
                    ...
                    <div class="col-lg-2 col-sm-6 col-xs-12 dash_box">
                        <a href="{{url('/')}}/sales_manager/rep_sales_cancel_orders">
                        <div class="white-box">
                            <div class="content">
                                <ul class="list-inline two-part">
                                <li class="icon-dashbrds icon-dash-style"><img src="{{url('/assets/front/images/icon-retailer-order-cancle.png')}}"></li>
                    ...
                    <div class="col-lg-2 col-sm-6 col-xs-12 dash_box">
                        <a href="{{url('/')}}/sales_manager/leads/net_30_pending_orders">
                        <div class="white-box">
                            <div class="content">
                                <ul class="list-inline two-part">
                                <li class="icon-dashbrds icon-dash-style"><img src="{{url('/assets/front/images/icon-retailer-order-pendding.png')}}"></li>
                    ...
                    <div class="col-lg-2 col-sm-6 col-xs-12 dash_box">
                        <a href="{{url('/')}}/sales_manager/leads/net_30_completed_orders">
                        <div class="white-box">
                            <div class="content">
                                <ul class="list-inline two-part">
                                <li class="icon-dashbrds icon-dash-style"><img src="{{url('/assets/front/images/icon-retailer-order-complete.png')}}"></li>
                   ...
                   <!--  <div class="col-lg-4 col-sm-6 col-xs-12">
                        <a href="{{url('/')}}/sales_manager/representative_listing">
                        <div class="white-box">
                            <h3 class="box-title">Total Representatives</h3>
                            <ul class="list-inline two-part">
                                <li class="icon-dashbrds"><i class="icon-people text-info"></i></li>
                                <li class="text-right"><span class="counter">{{ $rep_count or '0' }}</span></li>
                            </ul>
                        </div>
                     ...
                     <div class="col-lg-4 col-sm-6 col-xs-12">
                        ...
                        <div class="white-box">
                            <h3 class="box-title">Total Orders</h3>
                            <ul class="list-inline two-part">
                                <li class="icon-dashbrds"><i class="fa fa-list-ul text-success"></i></li>
                                <li class="text-right"><span class="counter">{{ $total_order_count or '0' }}</span></li>
                            </ul>
                        </div>
                        </a>
                    </div>
                    ...
                    <div class="col-lg-4 col-sm-6 col-xs-12">
                        <a href="{{url('/')}}/sales_manager/leads/confirmed">
                        <div class="white-box">
                            <h3 class="box-title">Total Confirmed Orders</h3>
                            <ul class="list-inline two-part">
                                <li class="icon-dashbrds"><i class="fa fa-list-ul text-success"></i></li>
                                <li class="text-right"><span class="counter">{{ $order_count or '0' }}</span></li>
                            </ul>
                        </div>
                        </a>
                    </div> -->
                     ...
                     <!--  <div class="col-lg-3 col-sm-6 col-xs-12 dash_box">
                        <a href="{{url('/')}}/sales_manager/leads/approved_orders">
                        <div class="white-box">
                            <div class="content">
                                <ul class="list-inline two-part">
                                <li class="icon-dashbrds icon-dash-style"><img src="{{url('/assets/front/images/icon-retailer-order-complete.png')}}"></li>
                                <li class="text-right"><span class="counter">{{ $order_count_arr['confirmed_count'] or '0' }}</span></li>
                            </ul>
                            </div>
                            <div class="dash-footer">
