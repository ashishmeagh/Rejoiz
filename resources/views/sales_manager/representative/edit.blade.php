      ...
      <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
         <ol class="breadcrumb">
           <li><a href="{{url('/')}}/sales_manager/dashboard">Dashboard</a></li>
            ...
            <li class="active">Edit Representative</li>
         </ol>
      </div>
      <!-- /.col-lg-12 -->
   </div>
          ...
          <div class="row">
            <form class="form-horizontal" id="validation-form" 
              ...
              <div class="form-group row">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-10">
                     <input type="text" class="form-control" name="last_name" placeholder="Enter Last Name" data-parsley-required="true" data-parsley-required-message="Please enter last name" data-parsley-pattern="^[a-zA-Z]+$" data-parsley-pattern-message="Please enter valid last name" value="{{$arr_user_data['last_name']}}"  />
                ...
                <div class="form-group row">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-10">
                     <input type="text" class="form-control" name="email" placeholder="Enter Email Id" data-parsley-required="true" data-parsley-required-message="Please enter email address" data-parsley-type="email" data-parsley-type-message="Please enter valid email address" value="{{$arr_user_data['email']}}"  />
                ...
                <div class="form-group row">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-10">
                     ...
                     <input class="form-control" placeholder="Enter Your Tax Id" type="text" name="tax_id" id="tax_id" data-parsley-trigger="change" data-parsley-whitespace="trim"  {{-- data-parsley-remote="{{ url('/does_exists_tax_id/tax-id') }}" --}}
                      data-parsley-remote-options='{ "type": "POST", "dataType": "jsonp", "data": { "_token": "{{ csrf_token() }}" }}'   data-parsley-remote-message="Tax id already exists" data-parsley-length="[9, 9]" data-parsley-length-message ="This value is invalid. It should have 9 digits" data-parsley-type="integer" data-parsley-type-message="Tax id can only be numbers" data-parsley-required="true" data-parsley-required-message="Please enter tax id" value="{{$arr_user_data['tax_id']}}"/>
                  </div>
               </div>
              ...
              <div class="form-group row">
                <label for="country" class="col-xs-12 col-sm-12 col-md-2 col-lg-2 col-form-label commonlabel_bold">Country<i class="red">*</i></label>
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-10">
             ...
             <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-10">
                     <input oninput="this.value = this.value.toUpperCase()" type="text" class="form-control" name="post_code" placeholder="Enter Zip/Postal Code" data-parsley-required="true" data-parsley-required-message="Please enter zip/postal code" data-parsley-trigger="change" value="{{$arr_user_data['post_code'] or ''}}" id= "pin_or_zip_code"/>
                          ...
                          @if(isset($all_vendors) && count($all_vendors)>0)
                               @foreach($all_vendors as $key=>$vendor)
                                   ...
                                   @if(isset($vendor['get_user_details']) && count($vendor['get_user_details']) > 0)
                                     ...
                                     <option value="{{$vendor['get_user_details']['id']}}" {{(in_array($vendor['get_user_details']['id'], $vendor_id_arr)) ? 'selected' : '' }}>{{$vendor['get_user_details']['maker_details']['company_name']}}</option>
             ...
             <div class="form-group row">                                   
               <label class="col-xs-12 col-sm-12 col-md-12 col-lg-2 control-label text-left commonlabel_bold" for="profile_image">Profile Image<i class="red">*</i> </label>
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-10">
                @php
                  $product_img_path = ""; 
...
$(document).ready(function(){
   var contact_no = jQuery("#contact_no").val(); 
    ...
    function validate_pin_or_zip_code(){
      ...
      jQuery("#contact_no").val(contact_no);
});
