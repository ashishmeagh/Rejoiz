                  ...
                  <div class="col-md-12">
                     <ul class="tb-links tab-find-link">
                        ...
                        @php
                           ...
                           if($order_no)
                           {
                              $url = url('/sales_manager/leads/find_products/').'/'.base64_encode($order_no);
                  ...
                  <form id="address-frm">
                     ...
                     <div class="form-group">
                         <label>Select Customer<span class="text-danger">*</span></label>
                           ...
                           <select class="select2" style="width: 100%" id="search-customer" data-parsley-required="true" data-parsley-required-message="Please select Customer">
                             ...
                             @foreach($retailer_arr as $key=>$retailer)
                                ...
                                @if(isset($arr_address) && count($arr_address)>0)
                                  ...
                                  <option class="l1" {{$arr_address['user_id'] == $retailer['retailer_id']? 'selected':''}} value="{{$retailer['retailer_id']}}">
                                
                                    {{isset($retailer['retailer_details']['store_name'])?$retailer['retailer_details']['store_name']:'-'}}
                                  </option>
                    ...
                    <div id="err_customer"></div>

            <div class="sale_lead_create_form_new">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-12 p-0">
                                <input type="text" class="form-control" placeholder="Enter First Name" id="ship_first_name" name="ship_first_name" data-parsley-required="true" data-parsley-required-message="Please enter first name" readonly=""data-parsley-pattern="^[a-zA-Z ]+$" data-parsley-pattern-message="Only alphabets are allowed" value="{{isset($arr_address['ship_first_name'])?$arr_address['ship_first_name']:''}}">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-12 p-0">
                                <input type="text" class="form-control" placeholder="Enter Last Name" id="ship_last_name" name="ship_last_name" data-parsley-pattern="^[a-zA-Z ]+$" data-parsley-pattern-message="Only alphabets are allowed" readonly=""data-parsley-required="true" data-parsley-required-message="Please enter last name" value="{{isset($arr_address['ship_last_name'])?$arr_address['ship_last_name']:''}}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">                    
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="col-md-12 p-0">Email Address <span class="text-danger">*</span></label>
                            <div class="col-md-12 p-0">
                ...
                <div class="row">
                    {{-- <div class="col-sm-6">
                        <div class="form-group">
                            <label class="col-md-12 p-0">Complete Address <span class="text-danger">*</span></label>
                            <div class="col-md-12 p-0">
                ...
                <div class="row">                    
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="col-md-12 p-0">City <span class="text-danger">*</span></label>
                            <div class="col-md-12 p-0">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="col-md-12 p-0">Country<span class="text-danger">*</span></label>
                            <div class="col-md-12 p-0">
                                <select class="form-control" id="ship_country" name="ship_country" data-parsley-required="true" data-parsley-required-message="Please select country" placeholder="Select Country">
                                    ...
                                    <option @if(isset($arr_address['ship_country']) && $arr_address['ship_country']==$country['id']) selected="selected" @endif phone_code="{{$country['phonecode'] or ''}}" zipcode_length="{{ $country['zipcode_length'] or '' }}" country_name="{{ $country['name'] or '' }}" value="{{$country['id']}}">{{$country['name'] or ''}}</option>
                                    @endforeach
                                    @endif  
                                </select>
                ...
                <div class="row">                    
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="col-md-12 p-0">Mobile Number <span class="text-danger">*</span></label>
                            <div class="col-md-12 p-0">
                                ...
                                <input type="text" class="form-control"
                                       ...
                                       data-parsley-minlength-message="Mobile number should be 10 digits"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="col-md-12 p-0">Zip/Postal Code <span class="text-danger">*</span></label>
                            <div class="col-md-12 p-0">
                                <input oninput="this.value = this.value.toUpperCase()" type="text" class="form-control" placeholder="Enter Zip Code" id="ship_zip_code" name="ship_zip_code" value="{{isset($arr_address['ship_zip_code'])?$arr_address['ship_zip_code']:''}}" data-parsley-required="true" data-parsley-required-message="Please enter zip/postal code">
                            </div>
                            <div class="err_zip_code space-left-error" id="err_shipping_zip_code"></div>
                        </div>
                    </div>
                </div>
                ...
                {{-- <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="col-md-12 p-0">First Name <span class="text-danger">*</span></label>
                            <div class="col-md-12 p-0">
                                <input type="text" class="form-control" name="bill_first_name" id="bill_first_name" placeholder="Enter First Name" data-parsley-required="true" data-parsley-required-message="Please enter first name." data-parsley-pattern="^[a-zA-Z ]+$" data-parsley-pattern-message="Plese enter valid first name." value="{{isset($arr_address['bill_first_name'])?$arr_address['bill_first_name']:''}}">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="col-md-12 p-0">Last Name <span class="text-danger">*</span></label>
                            <div class="col-md-12 p-0">
                                <input type="text" class="form-control" placeholder="Enter Last Name" name="bill_last_name" id="bill_last_name" data-parsley-required="true" data-parsley-required-message="PLease enter last name."  data-parsley-pattern="^[a-zA-Z ]+$" data-parsley-pattern-message="Please enter valid last name." value="{{isset($arr_address['bill_last_name'])?$arr_address['bill_last_name']:''}}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">                    
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="col-md-12 p-0">Email Address <span class="text-danger">*</span></label>
                            <div class="col-md-12 p-0">
                                <input type="text" class="form-control" placeholder="Enter Email Address" id="bill_email" name="bill_email" data-parsley-required="true" data-parsley-required-message="Please enter email address." readonly="true" data-parsley-type="email" data-parsley-type-message="Please enter valid email address."  value="{{isset($arr_address['bill_email'])?$arr_address['bill_email']:''}}">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="billing_street_address"  class="form-control" placeholder="Street Address" id="billing_street_address" data-parsley-required="true" row="5" data-parsley-required-message="Please enter street address. ">
                            </div>
                        </div>
                </div>
                ...
                <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="billing_suite_apt"  class="form-control" placeholder="Suite/Apt" id="billing_suite_apt" row="5">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12 p-0">
                                <select class="form-control" id="bill_country" name="bill_country" data-parsley-required="true" data-parsley-required-message="Please select country." placeholder="Select Country">
                                    ...
                                    @if(isset($country_arr) && count($country_arr)>0)
                                    @foreach($country_arr as $key=>$country)
                                    <option phone_code="{{$country['phonecode'] or ''}}" zipcode_length="{{ $country['zipcode_length'] or '' }}" country_name="{{ $country['name'] or '' }}" @if(isset($arr_address['bill_country']) && $arr_address['bill_country']==$country['id']) selected="selected" @endif value="{{$country['id']}}">{{$country['name']}}</option>
                                    @endforeach
                                    @endif  
                                </select>
                ...
                <div class="row">                    
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="col-md-12 p-0">Mobile Number <span class="text-danger">*</span></label>
                            <div class="col-md-12 p-0">
                                <input type="text" class="form-control" name="bill_mobile_no" id="bill_mobile_no" placeholder="Enter Mobile Number" data-parsley-required="true"  data-parsley-required-message="Please enter mobile number." data-parsley-minlength-message="Mobile number should be 10 digits" data-parsley-maxlength="18" data-parsley-maxlength-message="Mobile number should be 18 digits" data-parsley-pattern="^[0-9*#+]+$" data-parsley-required data-parsley-pattern-message="Please enter valid mobile number." value="{{isset($arr_address['bill_mobile_no'])?$arr_address['bill_mobile_no']:''}}">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="col-md-12 p-0">Zip/Postal Code <span class="text-danger">*</span></label>
                            <div class="col-md-12 p-0">
                                <input oninput="this.value = this.value.toUpperCase()" type="text" class="form-control" placeholder="Enter Zip Code" name="bill_zip" id="bill_zip" value="{{isset($arr_address['bill_zip_code'])?$arr_address['bill_zip_code']:''}}" data-parsley-required="true"  data-parsley-required-message="Please enter zip/postal code.">
                            </div>
                            <div class="err_zip_code space-left-error"  id="err_billing_zip_code"></div>
                        </div>
                    </div>
                </div> --}}
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="col-md-12 p-0">First Name <span class="text-danger">*</span></label>
                            <div class="col-md-12 p-0">
                                <input type="text" class="form-control" name="bill_first_name" id="bill_first_name" placeholder="Enter First Name" data-parsley-required="true" data-parsley-required-message="Please enter first name" readonly="" data-parsley-pattern="^[a-zA-Z ]+$" data-parsley-pattern-message="Plese enter valid first name" value="{{isset($arr_address['bill_first_name'])?$arr_address['bill_first_name']:''}}">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="col-md-12 p-0">Last Name <span class="text-danger">*</span></label>
                            <div class="col-md-12 p-0">
                                <input type="text" class="form-control" placeholder="Enter Last Name" name="bill_last_name" id="bill_last_name" data-parsley-required="true" data-parsley-required-message="PLease enter last name" readonly=""data-parsley-pattern="^[a-zA-Z ]+$" data-parsley-pattern-message="Please enter valid last name" value="{{isset($arr_address['bill_last_name'])?$arr_address['bill_last_name']:''}}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="col-md-12 p-0">Mobile Number <span class="text-danger">*</span></label>
                            <div class="col-md-12 p-0">
                                <input type="text" class="form-control" minlength="10" name="bill_mobile_no" id="bill_mobile_no" placeholder="Enter Mobile Number" data-parsley-required="true" data-parsley-required-message="Please enter mobile number" data-parsley-minlength-message="Mobile number should be 10 digits" data-parsley-maxlength="18"  data-parsley-maxlength-message="Mobile number must be less than 18 digits"  data-parsley-minlength="10" data-parsley-pattern="^[0-9*#+]+$" data-parsley-required data-parsley-pattern-message="Please enter valid mobile number" value="{{isset($arr_address['bill_mobile_no'])?$arr_address['bill_mobile_no']:''}}">
                                <input type="hidden" name="hid_bill_mobile_no_country_code" id="hid_bill_mobile_no_country_code">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="col-md-12 p-0">Zip/Postal Code <span class="text-danger">*</span></label>
                            <div class="col-md-12 p-0">
                                <input oninput="this.value = this.value.toUpperCase()" type="text" class="form-control" placeholder="Enter Zip Code" name="bill_zip" id="bill_zip_no" value="{{isset($arr_address['bill_zip_code'])?$arr_address['bill_zip_code']:''}}" data-parsley-required="true"  data-parsley-required-message="Please enter zip/postal code">
                            </div>
                            <div class="err_zip_code space-left-error"  id="err_billing_zip_code"></div>
                        </div>
                    </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
   ...
   $("#ship_country").change(function(){
    ...
    var country_code = $("#ship_country").val();
  ...
  $("#bill_country").change(function(){
    ...
    if(zipcode_length == 8)
    {
        $('#bill_zip_no').attr('parsley-maxlength', true);
        $('#bill_zip_no').removeAttr('data-parsley-length');
        $('#bill_zip_no').attr('data-parsley-length-message', "");
        $("#bill_zip_no").attr({
            "data-parsley-maxlength": zipcode_length,
            "data-parsley-maxlength-message": 'The ' + countryName + ' zipcode max upto ' +
            zipcode_length +
        ...
        $('#bill_zip_no').attr('parsley-maxlength', false);
        $('#bill_zip_no').attr('data-parsley-maxlength-message', "");
        $("#bill_zip_no").attr({
        "data-parsley-length": '[' + zipcode_length + ',' + zipcode_length + ']',
        "data-parsley-length-message": 'The ' + countryName + ' zipcode must contain ' +
            zipcode_length +
