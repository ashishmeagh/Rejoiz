...
$(document).ready(function() 
{
  ...
  if(title_description == null || title_description =='')
  {
    ...
    $("#item_qty").keyup(function(){
      ...
      {
      @endphp
        var qty_limit = product_max_qty_limit;
    ...
    else
    {
       ...
       $('#item_qty').keyup(function() {
        ...
        $("#item_qty").change(function(){
          $('#frm-add-to-bag').parsley().validate();
          total_wholesale_price = parseFloat(product_max_qty_limit) * parseFloat(product_price);
