                  ...
                  <table class="table table-striped" id="table_module">
                     <thead>
                        <tr>
                           ...
                           <th>Sales Manager Commission</th> 
                           <th>Action</th>
                        </tr>
                     </thead>
                     <tbody></tbody>
      ...
      
      {
        render(data, type, row, meta)
        {
            if (row.is_split_order == 1) {
              ...
              return `<a href="`+module_url_path+`/view_lead_listing/`+btoa(row.id)+`/`+btoa(row.order_no)+`">`+row.order_no+`</a> <span class="label label-success">Split</span>`
            }
