...
<div class="row bg-title">
   ...
   <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
      <ol class="breadcrumb">
         ...
         <li><a href="{{$module_url_path}}">Customer</a></li>
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-6">
                  <div class="form-group">
                    ...
                    <div>
                      <input type="text" class="form-control" name="first_name" placeholder="Enter First Name" data-parsley-required="true" data-parsley-required-message="Please enter first name" data-parsley-pattern="^[a-zA-Z]+$" value="{{$arr_user['first_name'] or ''}}"/>
                ...
                <div class="col-sm-12 col-md-12 col-lg-6">
                  <div class="form-group">
                    ...
                    <div>
                      <input type="text" class="form-control" name="last_name" placeholder="Enter Last Name" data-parsley-required="true" data-parsley-required-message="Please enter last name" data-parsley-pattern="^[a-zA-Z]+$" value="{{$arr_user['last_name'] or ''}}"/>
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-6">
                  <div class="form-group">
                    ...
                    <div>
                      <input type="text" class="form-control" name="email" placeholder="Enter Email" data-parsley-required="true" data-parsley-required-message="Please enter email" data-parsley-type="email" data-parsley-type-message="Please enter valid email" value="{{$arr_user['email'] or ''}}" />
                ...
                <div class="form-group">
                  <label>Tax Id<i class="red">*</i></label>
                     <input type="text" class="form-control" name="tax_id" placeholder="Enter Your Tax Id" data-parsley-trigger="change" data-parsley-whitespace="trim" data-parsley-remote="{{ url('/does_exists_tax_id/tax-id') }}" data-parsley-remote-options='{ "type": "POST", "dataType": "jsonp", "data": { "_token": "{{ csrf_token() }}","user_id":"{{$arr_user['id']}}" }}' data-parsley-remote-message="Tax Id already exists" data-parsley-required="true" data-parsley-required-message="Please enter tax id" data-parsley-length="[9, 9]" data-parsley-length-message ="Tax id is invalid. It should have 9 digits" data-parsley-type="integer" value="{{$arr_user['tax_id'] or ''}}"/>
                  ...
                  <div class="form-group">
                    ...
                    <div>
                      <select name="country_id" id="country_id" data-parsley-required="true" data-parsley-required-message="Please select country" class="form-control">
                        ...
                        <option value="{{$country['id']}}" @if($arr_user['country_id']==$country['id']) selected @endif phone_code="{{$country['phonecode'] or ''}}" phone_code="{{$country['phonecode'] or ''}}" zipcode_length="{{ $country['zipcode_length'] or '' }}" country_name="{{ $country['name'] or '' }}">{{$country['name'] or ''}}</option>
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-6">
                  <div class="form-group">
                    ...
                    <div>
                      @php
                        $status = isset($arr_user['buying_status'])?$arr_user['buying_status']:'';
                      @endphp
                      <select name="buying_status" id="buying_status" class="form-control" onchange="retailerStore($(this));">
                        <option>Select</option>
                        <option value="1" @if($status==1) selected @endif>Yes,I am buying for a physical retail store</option>
                        <option value="2" @if($status==2) selected @endif>No,I am buying for an online-only store</option>
                        <option value="3" @if($status==3) selected @endif>No,I am buying for a pop-up shop</option>
                        <option value="4" @if($status==4) selected @endif>None of the above apply</option>
                      </select>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6" id="store_data_container" style="display:none">
                  <div class="form-group" >
                     <label>Years in business<i class="red">*</i></label>
                        <input type="text" class="form-control" name="years_in_business" id="years_in_business" placeholder="Years in business" value="{{$arr_user_address['years_in_business'] or ''}}"/>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6" id="store_data_containers" style="display:none">
                <div class="form-group" >
                    <label>Annual Sales</label> 
                       <input class="form-control" placeholder="Annual Sales" type="text" name="Annual Sales" id="Annual_Sales" value="{{$arr_user_address['annual_sales'] or ''}}"/>
                  </div> 
              </div>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6" id="pop_up_data_container" style="display:none">
                <div class="form-group" >
                  <label class="col-form-label">Enter Zip Code<i class="red">*</i></label>
                   <input oninput="this.value = this.value.toUpperCase()" type="text" class="form-control" name="zip_code" id="zip_code" placeholder="Enter Zip Code" value="{{$arr_user['post_code'] or ''}}"/>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6" id=store_website_container style="display:none">
                <div class="form-group" >
                     <label class="col-form-label">Store Website<i class="red">*</i></label>
                        <input class="form-control" placeholder="Enter your store website" type="text" name="store_website" id="store_website" data-parsley-maxlength="50" data-parsley-type="url" value="{{$arr_user_address['store_website'] or ''}}"/>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6" style="display:none" id="store_name_container">
                <div class="form-group">
                  <label class="col-form-label">Store Name<i class="red">*</i></label>
                    <input class="form-control" placeholder="Enter your store name" type="text" name="store_name" id="store_name" data-parsley-maxlength="50" value="{{$arr_user['store_name'] or ''}}"/> 
                </div>
              </div>
...
<!-- END Main Content -->
   ...
   function validateZipAndPhoneCode()
  {
   ...
   $(document).ready(function(){
      ...
      var selected_value = $("#buying_status").val();
