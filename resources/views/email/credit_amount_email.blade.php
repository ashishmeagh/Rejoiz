                  ...
                  <td bgcolor="#FFFFFF" style="padding:15px; border:1px solid #e5e5e5;">
                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                           <td>
                              {{-- <p>Hello sir/Mam,</p>
                              <p>Your order ({!! isset($orderNo)?$orderNo:0.00 !!}) has been confirmed successfully! , <br /><label>${!! isset($amount)?$amount:0.00 !!}</label> is credited in your account,</p>
                              <p>order no: {!! isset($orderNo)?$orderNo:0.00 !!}</p>
