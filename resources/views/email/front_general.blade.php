...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   @php
      ...
      $arr_site_setting = get_site_settings(['site_logo']);
      $site_logo = url('/storage/app/'.$arr_site_setting['site_logo']);
                     ...
                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                           <td>
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                 <tr>
                                    <td><a href="{{url('/')}}"><img src="{{$site_logo or ''}}" width="150px" alt=""/></a></td>
