...
<script type="text/javascript">
  ...
  var table_module = false;
    ...
    $(document).ready(function() 
    {
        ...
        table_module = $('#table_module').DataTable({language: {
            ...
            'processing': '<div class="spinner"><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div></div>'
             ...
             ajax: {
                      url: module_url_path+'/get_all_third_sub_categories',
                      data:function(d)
                      {
                         /*send category id */
    ...
    function change_status(reference)
    {
        ...
        if(action == 'activate')
        {
           var msg = 'Are you sure? Do you want to activate this third level category.';
        }
        else if(action == 'deactivate')
        {
          var msg = 'Are you sure? Do you want to deactivate this third level category.'; 
        }
    ...
    {
      confirm_action(ref,event,'Are you sure? Do you want to delete this third level category.');
    }
