      ...
      <div class="col-sm-12">
        ...
        <div class="white-box">
        	<div class="pull-right top_small_icon">
             ...
             <a  href="{{url('/')}}/admin/customer/report_generator/csv" class="btn btn-outline btn-info btn-circle show-tooltip" title="Export as a CSV"><i class="fa fa-file-text"></i></a> 

             <a  href="{{url('/')}}/admin/customer/report_generator/xlsx" class="btn btn-outline btn-info btn-circle show-tooltip" title="Export as a xlsx"><i class="fa fa-file-excel-o"></i></a> 


              <a  href="{{url('/')}}/admin/customer/report_generator/pdf" class="btn btn-outline btn-info btn-circle show-tooltip" title="Export as a PDF"><i class="fa fa-file-pdf-o"></i></a> 
...
<script type="text/javascript">
  ...
  $(document).ready(function()
  {
      ...
      bFilter: false ,
      ajax: {
      'url':'{{ $module_url_path.'/get_customer'}}',
      'data': function(d)
        {
...
function net_30_statusChange(data)
{
  ...
  function changeAprovalStatus(customer_id,ref)
  {   
    ...
    function(isConfirm,tmp)
    {
        if(isConfirm==true)
        {
            var customerAprovalStatus = '';

            if($(ref).is(":checked"))
            {
              customerAprovalStatus = '1';
            }
            else
            {
              customerAprovalStatus = '0';
            }
           
            $.ajax({
                method   : 'GET',
                dataType : 'JSON',
                data     : {customer_id:customer_id,customerAprovalStatus:customerAprovalStatus,type : type},
