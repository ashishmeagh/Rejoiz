...
<script type="text/javascript">
  ...
  $(document).ready(function() 
  {
      ...
      stateSave: true,
            ...
            ajax: {
                    url:module_url_path+'/get_all_category',
                   ...
                   'data': function(d)
                        {
                          ...
                          d['column_filter[q_priority]']   = $("input[name='q_priority']").val()
        ...
        $("#table_module").find("thead").append(`<tr>
                    ...
                    <td><input type="text" name="q_priority" placeholder="Search" class="search-block-new-table column_filter form-control" /></td>
