 ...
 --}}
                        ...
                        <div class="col-md-12 commission_report_view_sec">
                          <div class="row">
                            ...
                            <div class="box">
                              <label class="font-larg-ventr">Total Amount Receivable From Vendor:</label>
                           ...
                           <div class="col-sm-4" id="first_load">
                            <div class="box">
                              <label class="font-larg-ventr">Total Amount Received By Vendor:</label>
                            ...
                            <table id="table_module" class="table table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Amount Received By Vendor</th>
...
<script type="text/javascript">
  ...
  function show_list()
  {
      ...
      ajax: {
      'url': module_url_path+'/admin_commission_reports',
      'data': function(d)
      {
         ...
         {    console.log(data)
              ...
              {   
                ...
                generate_invoice_url =  generate_invoice_url+'/'+btoa(row.order_id);
                 ...
                 return `<b><span class="text-warning">Pending</span></b><br><a class="btn btn-circle btn-success btn-outline show-tooltip" href="javascript:void(0)" title="Generate Invoice" onclick = generate_invoice(`+row.order_id+`)>Generate Invoice</a>`;
