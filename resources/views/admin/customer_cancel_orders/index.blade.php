         ...
         <div class="col-lg-12">
            ...
            <div class="white-box">
              ...
              <div class="col-sm-12 export-btn-div text-right p-0 mb-3">
                <button type="button" onclick="customerCancelOrderExport()" title="Export Customer Cancel orders as .csv" class="btn btn-success waves-effect waves-light filter_btn pull-right mt-0" value="export" id="customerCancelOrderExport">Export</button>
              </div>      
                 <form class="form-horizontal" id="report_form">
                    ...
                    <div class="row admin_data_filter_row">
                      <div class="admin_data_filter_input mr-2"> 
                        ...
                        <input type="text" class="form-control datepicker input-float" name="order_from_date" id="order_from_date" placeholder="Select From Date" {{-- data-parsley-required="true" data-parsley-required-message="Please enter order date." --}}/>

                      <span id="from_date_error" class="red"></span>
                     </div>
                     <div class="admin_data_filter_input mr-2"> 
                        <label>Order To Date</label>
                        <input type="text" class="form-control datepicker input-float" name="order_to_date" id="order_to_date" placeholder="Select To Date" {{-- data-parsley-required="true" data-parsley-required-message="Please enter order date." --}}/>
    ...
    $('#get_result').click(function(){
      ...
      // {data: 'store_name', "orderable": false, "searchable":false}, 
      {
        render(data, type, row, meta)
        {
            ...
            return `<a href="`+module_url+`/admin/customer/view/`+btoa(row.customer_id)+`" class="link_v">`+row.user_name+`</a>`
...
function customerCancelOrderExport(){
    ...
    $.ajax({
          ...
          success:function(data)
          {
            ...
            {
              saveData(data, 'customer_cancel_orders.csv');
            }
          }
        });
  }
