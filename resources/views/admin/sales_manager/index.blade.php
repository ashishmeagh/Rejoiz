      ...
      <div class="col-sm-12">
        ...
        <div class="white-box">
          <div class="pull-right top_small_icon">
            ...
            <a  href="{{$module_url_path}}/report_generator/csv" class="btn btn-outline btn-info btn-circle show-tooltip" title="Export as a CSV"><i class="fa fa-file-text"></i></a> 
            ...
            <a  href="{{$module_url_path}}/report_generator/pdf" class="btn btn-outline btn-info btn-circle show-tooltip" title="Export as a PDF"><i class="fa fa-file-pdf-o"></i></a> 
...
<script type="text/javascript">
  ...
  $(document).ready(function()
  {
      ...
      bFilter: false ,
      ajax: {
      'url': '{{ $module_url_path.'/get_sales_manager'}}',
      ...
      'data': function(d)
        {
          ...
          // d['column_filter[q_area]']       = $("input[name='q_area']").val()
          ...
          success: function(response)
          {
            if(response.status=='SUCCESS')
            {
              if(response.data=='ACTIVE')
              {
                ...
                // swal('Success','Sales manager has been activated.','success');
                swal({
                      title:"Success",
                      text: "Sales manager email status has been activated.",
                      type: "success",
              ...
              }else
              {
                ...
                swal('Success','Sales manager email status has been deactivated.','success');
              }
  ...
  function changeAprovalStatus(salesmanager_id,ref)
  {   
      ...
      function(isConfirm,tmp)
      {
          if(isConfirm==true)
          {
              var salesManagerAprovalstatus = '';
   
              if($(ref).is(":checked"))
              {
                 salesManagerAprovalstatus = '1';
              }
              else
              {
                salesManagerAprovalstatus = '0';
              }
               
              $.ajax({
                     method   : 'GET',
                     dataType : 'JSON',
                     data     : {salesmanager_id:salesmanager_id,salesManagerAprovalstatus:salesManagerAprovalstatus,type : type},
