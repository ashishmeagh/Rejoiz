      ...
      <div class="row">
         <div class="col-sm-12">
            ...
            <div class="white-box">
               ...
               <form class="form-horizontal" id="frm_manage" method="POST" action="{{ url($module_url_path.'/representative') }}">
                  {{ csrf_field() }}
                 <!--  <div class="col-md-12">
                     <div class="col-md-4">
                  ...
                  <div class="col-md-12">
                     ...
                     <div class="col-md-2">
                        <button type="button" title="Search" style="float: right" class="btn btn-success waves-effect waves-light m-r-10" value="Search" id="update">Search</button>
                     </div>
                    <!--  <div class="col-md-4">
  ...
  $(document).ready(function()
  {
    ...
    $('#update').click(function(){
     ...
     $('.datepicker').datepicker({
      ...
      bFilter: false ,
      ajax: {
      'url':'{{ $module_url_path.'/all_reports/sales_manager'}}',
      'data': function(d)
        {
    ...
    /*search box*/
     $("#table_module").find("thead").append(`<tr>
                    ...
                    <td><input type="text" name="q_sales_name" placeholder="Search" class="search-block-new-table column_filter form-control-small" /></td>
