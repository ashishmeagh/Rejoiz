               ...
               <tr>
                  ...
                  <td>
                    @if(isset($lead['product_details']['description']) && strlen($lead['product_details']['description']) > 70 && $lead['product_details']['description']!='' )   
                        @php
                        /*$desc_html = html_entity_decode($lead['product_details']['description']);
                ...
                <?php
                    ...
                    $tot_unit_price_wholesale+=(float)$lead['product_details']['unit_wholsale_price'];
         ...
         {{-- <div class="col-md-12">
          ...
          <div class="col-md-12">
            <div class="pull-right totl-grands" >
               ...
               <div class="viewtotal-bg">
                  <span>Promotion Discount ({{ isset($orderCalculationData['discount_per'])?$orderCalculationData['discount_per'] : 0 }}%):</span>
                  <span class="viewspan">
