      ...
      <div class="col-sm-12">
        ...
        <div class="white-box">
          <div class="pull-right top_small_icon">
            ...
            <button type="button" onclick="customerRefundExport()" title="Export Customer Refund as .csv" class="btn btn-success waves-effect waves-light pull-right" value="export" id="customerRefundExport">Export</button>
...
function customerRefundExport(){
    ...
    $.ajax({
          url: module_url_path+'/get_export_customer_refund',
          data: {q_order_no:q_order_no,q_customer_name:q_customer_name,q_paid_by:q_paid_by,q_transaction_id:q_transaction_id,q_amount:q_amount,q_transaction_status:q_transaction_status,q_created_at:q_created_at},
          ...
          success:function(data)
          {
            ...
            {
              saveData(data, 'customer_refunds.csv');
            }
          }
        });
  }
