      ...
      <div class="white-box small-space-nw">
        <div class="row">
         ...
         @if($status=="Paid")        
          ...
          <div class="col-sm-12 col-md-6 col-lg-6 orders_view">
            <div class="row">
              <label class="col-sm-12 col-md-12 col-lg-4 commonlabel_bold">Retailer</label>
              <div class="col-sm-12 col-md-12 col-lg-8">
                <a href="{{url('/')}}/admin/retailer/view/{{$retailerId}}" class="link_view">
                  <span>{{ isset($enquiry_arr['user_details']['retailer_details']['store_name'])?$enquiry_arr['user_details']['retailer_details']['store_name']:'N/A' }}</span>
                </a>
              </div>
            </div>

             <div class="row">
              <label class="col-sm-12 col-md-12 col-lg-4 commonlabel_bold">Total Amount (Wholesale)</label>
              <div class="col-sm-12 col-md-12 col-lg-8">
            ...
            <table class="table table-striped table-bordered view-porifile-table">
               ...
               <tr>
                 ...
                 {{--  @if(isset($quote['product_details']['description']) && strlen($quote['product_details']['description']) > 70)
                  ...
                  <td class="summmarytdsprice"><span class="fa fa-dollar"></span>{{$quote['product_details']['unit_wholsale_price'] or 'N/A' }}</td>
                         
                  <td class="summmarytdsprice">
                     @php  

                      //$sub_retail_price = $quote['qty'] * $quote['wholesale_price'] 
                      $sub_retail_price = $quote['qty'] * $quote['product_details']['unit_wholsale_price']; 

                      $sub_wholesale_total = $sub_retail_price+$quote['shipping_charge']-$quote['shipping_discount']-$quote['product_discount'];

                      $total_amount += $sub_wholesale_total; 
                  ...
                  <td>@if($quote['shipping_charge']>0)+@endif<span class="fa fa-dollar"></span>{{isset($quote['shipping_charge'])?num_format($quote['shipping_charge']):0.00}}
                  </td>
               ...
               <?php
                    ...
                    $tot_unit_price_wholesale+=(float)$quote['product_details']['unit_wholsale_price'];
           ...
           {{--  <div class="col-sm-6 pull-right viewsummaryamtbox">
               ...
               @if(isset($enquiry_arr['promotion_discount']) && $enquiry_arr['promotion_discount'] != '' && $enquiry_arr['promotion_discount'] != 0)
                  ...
                  <div class="row totalrow">
                    ...
                    <div class="right">
                      <span><i class="fa fa-usd" aria-hidden="true"></i>{{ isset($enquiry_arr['total_wholesale_price'])?num_format($enquiry_arr['total_wholesale_price']) : 'N/A' }}</span>
                    </div>
                  </div>
                @else
                  <div class="row totalrow">
                    ...
                    <div class="right">
                      <span><i class="fa fa-usd" aria-hidden="true"></i>{{ isset($enquiry_arr['total_wholesale_price'])?num_format($enquiry_arr['total_wholesale_price']) : 'N/A' }}
                    </span>
                    </div>
                  </div>
                 @endif    
