        ...
        <div class="white-box">
         ...
         <div class="row">
          ...
          <div class="col-sm-12 col-md-12 col-lg-6">
            ...
            <div class="col-sm-8">
              <span>{{ isset($subcat_data['third_sub_category_name']) ? $subcat_data['third_sub_category_name'] : "" }}</span>
               <input type="hidden" name="third_sub_category_name" id="third_sub_category_name" value="{{ isset($subcat_data['third_sub_category_name']) ? $subcat_data['third_sub_category_name'] : "" }}">
            </div>
            </div>
          </div>
          ...
          <div class="col-sm-12 col-md-12 col-lg-6">
            <div class="row">
              <div class="col-sm-4">
              <label>Fourth Level Category</label>
            </div>
            <div class="col-sm-8">
              <span>{{ isset($subcat_data['fourth_sub_category_name']) ? $subcat_data['fourth_sub_category_name'] : "" }}</span>
               <input type="hidden" name="fourth_sub_category_name" id="fourth_sub_category_name" value="{{ isset($subcat_data['fourth_sub_category_name']) ? $subcat_data['fourth_sub_category_name'] : "" }}">
            </div>
            </div>
          </div>
...
{
  var sub_cat_name = $("#fourth_sub_category_name").val();
