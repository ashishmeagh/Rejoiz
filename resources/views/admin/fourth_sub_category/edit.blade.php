      ...
      $.ajax({
         ...
         success:function(response)
         {
            ...
            if(response.status=='SUCCESS')
            {
               ...
               {              
                  $(response.third_sub_categories_arr).each(function(index,sub_category_id_arr)
                  {
                     $(sub_category_id_arr).each(function(index, third_category) 
                     {
      ...
      $.ajax({
         ...
         success:function(response)
         {
            ...
            if(response.status=='SUCCESS')
            {
               ...
               {              
                  $(response.fourth_sub_categories_arr).each(function(index,fourth_sub_categories_arr)
                  {
