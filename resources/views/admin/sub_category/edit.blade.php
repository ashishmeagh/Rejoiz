                  ...
                  <div class="tab-pane fade {{ $lang['locale']=='en'?'in active':'' }}"
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-10 controls">
                          ...
                          @if($lang['locale'] == 'en')
                           {!! Form::text('sub_category_name_'.$lang['locale'],$locale_sub_category_name,['class'=>'form-control','data-parsley-required'=>'true','data-parsley-required-message'=>'Please enter subcategory','id' => 'sub_category_name', 'data-parsley-pattern'=>'^[a-zA-Z&/ ]+$','placeholder'=>'Please Enter Subcategory']) !!}
                           @else
