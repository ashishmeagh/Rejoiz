            ...
            @include('admin.layout._operation_status')
              ...
              <div class="butns-right">            
                <div class="col-sm-12 export-btn-div text-right p-0 mb-3">
                  <button type="button" onclick="retailerOrderExport()" title="Export Customer orders as .csv" class="btn btn-success waves-effect waves-light filter_btn pull-right" value="export" id="retailerOrderExport">Export</button>
                </div>
                    ...
                    <div class="form-group row admin_data_filter_row">
                     ...
                     <div class="admin_data_filter_input">
                      <label class="label-float" for="category">Order To Date</label>
                        ...
                        <input type="text" class="form-control datepicker input-float" name="order_to_date" id="order_to_date" placeholder="Select To Date" data-parsley-required="true" data-parsley-required-message="Please select order to date" readonly="true" />
...
<script type="text/javascript">
  ...
  $(document).ready(function()
  {
      ...
      'data': function(d)
       {        
          ...
          d['column_filter[q_vendor_payment_status]'] = $("select[name='q_vendor_payment_status']").val()
          d['column_filter[q_admin_payment_status]'] = $("select[name='q_admin_payment_status']").val()
         ...
         { 
          ...
          /* if (row.is_direct_payment == '1') 
           ...
           else
           {
            ...
            switch(row.maker_commission_status)
            {
              case 1: return `<span class="label label-success">Paid</span>`;
                      break;
         ...
         { 
          ...
          /* if (row.is_direct_payment == '0') 
           ...
           else
           {
            ...
            switch(row.admin_commission_status)
            {
              case 1: return `<span class="label label-success">Paid</span>`;
                      break;
              default: return `<span class="label label-warning">Pending</span>`;
  ...
  $("#table_module").find("thead").append(`<tr>          
          ...
          <td>
            ...
            <td>
            <select class="search-block-new-table column_filter form-control-small" name="q_vendor_payment_status" id="q_vendor_payment_status" onchange="filterData();">
                  <option value="">All</option>
                  <option value="0">Pending</option>
            ...
            <td>
            <select class="search-block-new-table column_filter form-control-small" name="q_admin_payment_status" id="q_admin_payment_status" onchange="filterData();">
                  <option value="">All</option>
                  <option value="0">Pending</option>
                  <option value="1">Paid</option>
            </select>
...
<script type="text/javascript">
 ...
 function generate_invoice(order_no = false)
  ...
  function retailerOrderExport(){
    ...
    var q_vendor_payment_status        = $("select[name='q_vendor_payment_status']").val();
    var q_admin_payment_status        = $("select[name='q_admin_payment_status']").val();
    ...
    $.ajax({
          ...
          data: {q_order_no:q_order_no,q_enquiry_date:q_enquiry_date,q_retailer_name:q_retailer_name,q_company_name:q_company_name,q_total_wholesale_cost:q_total_wholesale_cost,q_ship_status:q_ship_status,q_payment_status:q_payment_status,q_vendor_payment_status:q_vendor_payment_status,q_admin_payment_status:q_admin_payment_status,q_payment_term:q_payment_term,q_vendor_payment:q_vendor_payment,q_from_date:q_from_date,q_to_date:q_to_date},
