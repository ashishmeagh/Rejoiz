      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                  <div class="white-box" style="overflow:hidden;">
                    ...
                    <div id="order_amount_container">
                      <div class="col-sm-12 pull-right viewsummaryamtbox" >
                        <div class ="row totalrow col-sm-6 pull-right">
                          <div class="left">
            ...
            <div id = "pagination_container" class ="col-sm-12"></div>
...
<script type="text/javascript">
  ...
  $("#order_amount_container").append($(".dataTables_paginate"));
  $("#order_amount_container").append($(".dataTables_info"));
  });
