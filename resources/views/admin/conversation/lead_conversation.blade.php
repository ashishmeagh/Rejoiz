...
<div class="row bg-title">
   ...
   <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
      <ol class="breadcrumb">
          ...
          <li><a href="{{ $module_url_path }}">Leads</a></li>
                        ...
                        <div class="chat-left-inner">
                          <div class="user-profile-chat-main left-mkr-chat">
                            <div class="user-profile-chat">
                              <img alt="male" id="retailer-prof-img" src="{{ getProfileImage($lead_arr['representative_user_details']['profile_image']) }}" height="100px" width="100px">
                            </div>
