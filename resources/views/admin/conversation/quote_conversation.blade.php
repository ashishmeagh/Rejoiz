...
<div class="row bg-title">
   ...
   <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
      <ol class="breadcrumb">
          ...
          <li><a href="{{ $module_url_path }}">Quotes</a></li>
                        ...
                        <div class="chat-left-inner">
                          <div class="user-profile-chat-main">
                            <div class="user-profile-chat">
                              <img alt="male" id="retailer-prof-img" src="{{ getProfileImage($quote_arr['user_details']['profile_image']) }}" width="100px" height="100px">
                            </div>
