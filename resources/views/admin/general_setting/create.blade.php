                            ...
                            <div class="row">
                                ...
                                <div class="form-group row">
                                  ...
                                  <div class="col-10">
                                    ...
                                    <input type="text" name="order_sequence" id="order_sequence" class="form-control" data-parsley-required="true" placeholder="Enter Sequence" data-parsley-pattern="^[0-9]+$" data-parsley-pattern-message="Only Numbers Are Allowed.">
                                 ...
                                 <div class="form-group row">
                                  ...
                                  <div class="col-10">
                                  <input type="file" name="banner_image" id="banner_image" class="dropify" data-parsley-required="true" data-max-file-size="2M" data-allowed-file-extensions="png jpg JPG jpeg JPEG" data-errors-position="outside" data-parsley-errors-container="#image_error">
