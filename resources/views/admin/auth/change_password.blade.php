            ...
            <div class="col-sm-12 col-xs-12">
               ...
               <div class="form-group row">
                  ...
                  <div class="col-sm-12 col-md-12 col-lg-9">
                     ...
                     'data-parsley-required'=>'true',
                     'data-parsley-required-message'=>'Please reenter new password',
               ...
               <div class="form-group row">
                  <div class="col-12">
                     ...
                     <button type="submit" style="float:right" class="btn btn-success waves-effect waves-light" value="Save" id="save">Save</button>
                  </div>
               </div>
               {!! Form::close() !!}
            </div>
