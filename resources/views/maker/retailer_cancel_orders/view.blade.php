            ...
            <div class="col-sm-6">
               ...
               <div class="row">
                  ...
                  <div class="col-sm-8">
                     ...
                     <span> {{isset($enquiry_arr['user_details']['retailer_details']['dummy_store_name'])?ucfirst($enquiry_arr['user_details']['retailer_details']['dummy_store_name']):"N/A"}}</span>
                  </div>
               </div>
               <div class="row">
            ...
            <div class="col-sm-6">
               <div class="row">
                  ...
                  <div class="col-sm-8">
                     ...
                     <!-- Mobile.No : {{isset($enquiry_arr['user_details']['retailer_details']['ship_contact_no'])?$enquiry_arr['user_details']['retailer_details']['ship_contact_no']:'N/A'}}
 -->
                     </span>
                  </div>
               </div>
               <div class="row">
                  ...
                  <div class="col-sm-8">
                     ...
                     {{isset($enquiry_arr['billing_addr'])?$enquiry_arr['billing_addr'].',':'N/A'}}
                      <!-- Mobile.No : {{isset($enquiry_arr['user_details']['retailer_details']['bill_contact_no'])?$enquiry_arr['user_details']['retailer_details']['bill_contact_no']:'N/A'}} -->
                     </span>
                  </div>
               </div>
         ...
         <div class="table-responsive">
            <table class="table table-striped table-bordered view-porifile-table">
               ...
               <tr>
                  ...
                  <td>{{isset($quote['sku_no'])?$quote['sku_no']:""}}</td>
            ...
            <div class="col-md-12 retailer_cancel_order_view_summary_btn">
               <div class="row">
              <div class="pull-left">
               <div class="btn-cnt">
