 ...
 --}}
                        ...
                        <div class="col-md-12 commission_report_view_sec">
                          <div class="row">
                            ...
                            <div class="box">
                              <label class="font-larg-ventr">Total Commission Pending From {{$site_setting_arr['site_name'] or ''}}:</label>
                           ...
                           <div class="col-sm-4" id="first_load">
                            <div class="box">
                              <label class="font-larg-ventr">Total Commission Received From {{$site_setting_arr['site_name'] or ''}}:</label>
