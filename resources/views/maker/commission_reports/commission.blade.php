                    ...
                    <form class="form-horizontal" id="frm_manage" method="POST" action="{{$exprot_csv_url}}">
                        ...
                        <div class="row commission_filter_row">
                           ...
                           {{--  <div class="col-md-3 mb-4">
                            ...
                            <div class="col-md-3 mb-4"> 
                              ...
                              {{--   <input type="text" name="q_order_no" placeholder="Search" class="search-block-new-table column_filter form-control-small" id = q_order_no style="display: none;"/>

                                <input type="text" name="q_order_date" placeholder="Search" class="datepicker form-control" data-date-format="mm/dd/yyyy" id = q_order_date style="display: none;" />

                                <input type="text" name="q_order_amount" placeholder="Search" class="search-block-new-table column_filter form-control-small" id = q_order_amount style="display: none;" />  
         
                               <input type="text" name="q_amount_received" placeholder="Search" class="search-block-new-table column_filter form-control-small" id = q_amount_received style="display: none;" />
         
                                <input type="text" name="q_admin_commission_amount" placeholder="Search" class="search-block-new-table column_filter form-control-small" id = q_status style="display: none;" />
                                              
                                <select style="display: none;" class="search-block-new-table column_filter form-control-small" name="q_product_status" id="q_status" onchange="filterData();">
                           ...
                           --}}
                                ...
                                <div class="col-sm-12 mb-4 btnscenter rw-comission-vendor-btnscenter">
                        ...
                        <div class="col-md-12 commission_report_view_sec">
                          <div class="row">
                            ...
                            <div class="box">
                              <label class="font-larg-ventr">Total Amount Pending From {{$site_setting_arr['site_name'] or ''}}:</label>
                           ...
                           <div class="col-sm-4" id="first_load">
                            <div class="box">
                              <label class="font-larg-ventr">Total Amount Received:</label>
                          ...
                          <div class="col-sm-4">
                            <div class="box">
                              <label class="font-larg-ventr">Total Admin Commission Given:</label>                            
                            <h5>
...
<script type="text/javascript">
  ...
  function show_list()
  {
      ...
      ajax: {
      'url': module_url_path+'/get_commissions',
      'data': function(d)
      {
         ...
         { 
              ...
              {   
                  ...
                  if(row.is_direct_payment==1)
                  {
                   ...
                   return `<b><span class="label label-success">Pending</span></b><br><a class="btn btn-circle btn-success btn-outline show-tooltip" href="javascript:void(0)" title="Generate Invoice" onclick = generate_invoice(`+row.order_id+`)>Generate Invoice</a>`;
                 }
                 else
                 {

                  return `<b><span class="label label-success">Pending</span></b>`;
                 }                      
              }
              else if(row.status==2)
              {
                return `<b><span class="label label-success">Paid</span></b>`;
              }
              else
              {
                return `<b><span class="label label-success">Failed</span></b>`;
              }
          }
      },    
     ...
     /*search box*/
var is_thead =  $("#table_module").find("thead").html();
 /* $("#table_module").find("thead").append(`<tr>
         
          <td><input type="text" name="q_order_no" placeholder="Search" class="search-block-new-table column_filter form-control-small" id = q_order_no/></td>  

          <td><input type="text" name="q_order_date" placeholder="Search" class="search-block-new-table column_filter form-control-small" id = q_order_date /></td> 

          <td><input type="text" name="q_order_amount" placeholder="Search" class="search-block-new-table column_filter form-control-small" id = q_order_amount/></td>   
         
          <td><input type="text" name="q_amount_received" placeholder="Search" class="search-block-new-table column_filter form-control-small" id = q_amount_received/></td>
         
          <td><input type="text" name="q_admin_commission_amount" placeholder="Search" class="search-block-new-table column_filter form-control-small" id = q_status /></td> 
                                              
          <td>
             <select class="search-block-new-table column_filter form-control-small" name="q_product_status" id="q_status" onchange="filterData();">
              <option value="">All</option>
              <option value="1">Pending</option>
              <option value="2">Paid</option>
              <option value="3">Failed</option>
...
function generate_invoice(order_no = false)
{
  ...
  var order_no = order_no;
   var generate_invoice_url  = "{{ $generate_invoice_url or '' }}";
   generate_invoice_url =  generate_invoice_url+'/'+btoa(order_no);
