                        ...
                        <div class="row commission_filter_row">
                            ...
                            <div class="col-md-3 mb-4"> 
                                <label>From Date</label>
                                    <input type="text" name="from_date" class="datepicker form-control" data-date-format="mm-dd-yyyy" id="from_date" placeholder="From Date">
                                </div>
                                <div class="col-md-3 mb-4"> 
                                    <label>To Date</label>
                                    <input type="text" name="to_date" class="datepicker form-control" data-date-format="mm-dd-yyyy" id="to_date" placeholder="To Date">
                                </div>
