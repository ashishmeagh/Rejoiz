...
<div class="row bg-title">
   ...
   <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
      <ol class="breadcrumb">
          ...
          <li><a href="{{ $module_url_path or '' }}">Retailer Quotes</a></li>
                        ...
                        <div class="chat-left-inner">
                          <div class="user-profile-chat-main">
                            <div class="user-profile-chat">
                              <img alt="male" id="retailer-prof-img" src="{{ getProfileImage($quote_arr['user_details']['profile_image']) }}">
                            </div>
                            <div class="user-profile-chat-txt">{{ $quote_arr['user_details']['first_name'].' '.$quote_arr['user_details']['last_name']}} </div>                             
{{--                              <div class="price-quote">$ {{ $quote_arr['total_retail_price'] or ''}}</div>
 --}}                          </div>
                      ...
                      {{--   <div class="chat-main-header">
                        ...
                        <div class="chat-main-header">
                               <div class="quote-cnvrttion"><span id="chat-title">Chat Details</span>
                                ...
                                @if(check_is_user_online($quote_arr['retailer_id']))
                                ...
                                <div class="main-quote-dtls" id="quote-details" style="display: none;">
                                  <div class="row">
                                    ...
                                    <div class="col-md-6">
                                      <div class="table-style-mkr">
                                        <div class="enquiry-id-left">Retailer Name</div>
                                        <div class="enquiry-id-right">{{ $quote_arr['user_details']['first_name'] or '' }} {{ $quote_arr['user_details']['last_name'] or '' }}</div>
                                        <div class="clearfix"></div>
                                      </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                      <div class="table-style-mkr">
                                        ...
                                        <div class="enquiry-id-right">$ {{ isset($quote_arr['total_retail_price'])?num_format($quote_arr['total_retail_price']) : '' }}</div>
                                        <div class="clearfix"></div>
                                      </div>
                                    </div>
                                  </div>
                                ...
                                <div class="col-sm-12">
                                  <form id="chat-frm">
                                    {{ csrf_field() }}                                     
                                     ...
                                     <input type="hidden" name="receiver_id" id="receiver_id" value="{{ $quote_arr['retailer_id'] or '' }}"> 
                         ...
                         chat_box = `<li>
                                        ...
                                        <div class="chat-body">
                                            <div class="chat-text">
                                                ...
                                                <b>
                                                `+moment(chat_obj.created_at).format("HH:mm A")+`</b>
                                                <div class="clearfix"></div>
                                                <p>`+msgContent+`</p>  </div>
