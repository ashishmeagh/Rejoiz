 ...
 -->
             ...
             <div class="butns-right">            
              <div class="col-sm-12 text-right export-btn-div p-0 mb-3">
                <button type="button" onclick="retailerOrderExport()" title="Export Customer Orders as .csv" class="btn btn-success waves-effect waves-light filter_btn" value="export" id="retailerOrderExport">Export</button>
              </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function()
  {
...

     {
      ...
      {data: 'admin_commission_status', "orderable": false, "searchable":false},   
  ...
  function retailerOrderExport(){
    ...
    $.ajax({
          ...
          data: {q_enquiry_id:q_enquiry_id,q_retailer_name:q_retailer_name,q_total_wholesale_cost:q_total_wholesale_cost,q_ship_status:q_ship_status,q_payment_status:q_payment_status,q_enquiry_date:q_enquiry_date,retailer_id:retailer_id,q_order_from_date:q_order_from_date,q_order_to_date:q_order_to_date,q_payment_term:q_payment_term,admin_commission_status:admin_commission_status},
