          ...
          <form id="upload_zip_file" class="rw-vendor-upload-zip" enctype="multipart/form-data" method="POST" >
           ...
           <div class="col-sm-12 terms red">
              <ul>
                ...
                <li>If you want to upload product's multiple images,folder name must be SKU Number of its product images.</li>
...
function checkfilesize() {
    ...
    if ($.inArray(ext, ['zip']) == -1) {
        ...
        $.ajax({
            url: "{{url('/')}}/{{$maker_panel_slug}}" + '/product_images/uploadZip',
            type: "POST",
            data: formdata,
            contentType: false,
            processData: false,
