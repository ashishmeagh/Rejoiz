   ...
   <div class="col-sm-12">
      <div class="white-box">
          {!! Form::open([ 'url' => $module_url_path.'/multi_action',
            ...
            {{ csrf_field() }}
          <a href="{{ url($module_url_path.'/create') }}" class="btn btn-outline btn-info show-tooltip" title="Add Catalog Image"> Add Catalog Image</a> 
...
<script type="text/javascript">
  ...
  alert(module_url_path+'/get_catlogs');
