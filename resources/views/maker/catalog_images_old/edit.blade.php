            ...
            <div class="col-sm-12 col-xs-12">
               ...
               <div  class="tab-content">
                   ...
                   <div class="form-group row">
                      <label class="col-2 col-form-label" for="catalog_image"> Catalogs Image
                      </label>
                      <div class="col-md-10">
                        <input type="file" name="catalog_image" id="catalog_image" class="dropify" data-default-file="{{ url('/storage/app/'.$catlog_arr['image'])}}" data-allowed-file-extensions="png jpg JPG jpeg JPEG" data-errors-position="outside" 
                        />
                      </div>
                    </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-10">
                     <input type="text" name="sequence" id="sequence" class="form-control" placeholder="Sequence"  data-parsley-maxlength="50"  data-parsley-whitespace="trim" data-parsley-required="true" data-parsley-required-message="Please enter sequence." value="{{$catlog_arr['sequence'] or ''}}" />
                   </div>
                  </div>

                    <input type="hidden" name="old_catlog_image" value="{{$catlog_arr['image'] or ''}}">
