   ...
   <div class="col-sm-12">
      <div class="white-box">
            ...
            <div class="col-sm-12 col-xs-12">
              ...
              <div  class="tab-content">
                  ...
                  <div class="form-group row">
                    <label class="col-sm-12 col-md-12 col-lg-2 col-form-label" for="name">Name<i class="red">*</i></label>
              ...
              <div  class="tab-content">
                  ...
                  <div class="form-group row">
                    ...
                    <label class="col-sm-12 col-md-12 col-lg-2 col-form-label" for="catlog_image">Pdf<i class="red">*</i></label>
                    <div class="col-sm-12 col-md-12 col-lg-10">
                      <div class="indext-jtsd space-index rw-upload-pdf">
                      <div class="nt-rxlcs">
                       <input type="file" class="idx-imprt" name="upload_pdf" id="upload_pdf" data-parsley-required="true" data-parsley-required-message="Please select pdf" data-parsley-trigger="change" data-default-file data-allowed-file-extensions="pdf" data-parsley-errors-container="#err_container">
               ...
               <div  class="tab-content">
                  ...
                  <div class="form-group row">
                    <label class="col-sm-12 col-md-12 col-lg-2 col-form-label" for="catlog_image">Cover Image<i class="red">*</i></label>
                    <div class="col-sm-12 col-md-12 col-lg-10">
          ...
          <br>
               ...
               <div class="form-group row">
                  <div class="col-md-12 common_back_save_btn text-left">
