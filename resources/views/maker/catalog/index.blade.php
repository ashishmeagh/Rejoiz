...
<script type="text/javascript">
  ...
  var cover_img_path = "{{$cover_image_path or ''}}";
  var table_module;
      ...
      stateSave: true,
            ...
            columns: [
...

                  {
                     render : function(data, type, row, meta) 
                     {
                        return '<img src="'+cover_img_path+'/'+row.cover_image+'" height="100" width="100"></>';
                     },
                     "orderable": false
                  },
                  ...
                  {                  
                    ...
                    {
                         return `
                          <a href="`+module_url_path+`/edit/`+btoa(row.id)+`" data-toggle="tooltip"  data-size="small" title="Edit Catalog" class="btn btn-outline btn-primary btn-circle show-tooltip">Edit</a>
                          ...
                          <a href="`+cover_img_path+row.pdf_file+`" data-toggle="tooltip" download="" data-size="small" title="Download Catalog PDF" class="btn btn-outline btn-primary btn-circle btn-outline show-tooltip">Download PDF</a>
