         ...
         <div class="col-lg-12">
            ...
            <div class="white-box">
               <div class="pull-right top_small_icon">            
                ...
                <button type="button" onclick="repSaleCancelOrderExport()" title="Export reps sales cancel order transaction as .csv" class="btn btn-success waves-effect waves-light filter_btn pull-right mr-2 ml-2" value="export" id="repSaleCancelOrderExport">Export</button>           
              </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function()
  {
      ...
      'data': function(d)
       {        
          ...
          d['column_filter[q_rep_sales_name]']  = $("select[name='q_rep_sales_name']").val()
  ...
  $("#table_module").find("thead").append(`<tr>          
          ...
          <td>
             <select class="search-block-new-table column_filter form-control-small" name="q_rep_sales_name" id="q_rep_sales_name" onchange="filterData();">
...
function repSaleCancelOrderExport(){ 
    ...
    $.ajax({
          url: module_url_path+'/get_export_rep_sale_cancel_order',
          data: {q_order_no:q_order_no,q_retailer_name:q_retailer_name,q_enquiry_date:q_enquiry_date,q_total_wholesale_cost:q_total_wholesale_cost,q_rep_sales_name:q_rep_sales_name,q_payment_status:q_payment_status,q_order_from_date:q_order_from_date,q_order_to_date:q_order_to_date,q_refund_status:q_refund_status},
          ...
          success:function(data)
          {
            ...
            {
              saveData(data, 'reps_sales_cancel_order.csv');
            }
          }
        });
 }
