      ...
      <div class="white-box">
         ...
         {{ csrf_field() }}
          <div class="pull-right top_small_icon">
            ...
            <a  href="javascript:void(0);" onclick="javascript : return check_multi_action('checked_record[]','frm_manage','delete');" class="btn btn-circle btn-info btn-outline show-tooltip" title="Multiple Delete"><i class="ti-trash"></i> </a>
            ...
            <table class="table table-striped"  id="table_module" >
               ...
               <tbody>
                  ...
                  <tr>
                    ...
                    @else
                     <td><!-- {!! $notification['description'] or ''!!} -->
                        @if(isset($notification['is_read']) && $notification['is_read'] == 0)
                    ...
                    @endif
                     ...
                     <td>
                         <a href="{{$module_url_path}}/delete/{{base64_encode($notification['id'])}}" data-toggle="tooltip"  data-size="small" title="Delete" class="btn btn-outline btn-primary btn-circle show-tooltip btn-retailer-view" onclick="confirm_delete(this,event);">Delete</a>
