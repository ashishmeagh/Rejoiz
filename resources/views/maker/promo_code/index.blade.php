...
<script type="text/javascript">
  ...
  $(document).ready(function() 
  {
      ...
      stateSave: true,
            ...
            ajax: {
                    url:module_url_path+'/get_maker_promo_code',

                   'data': function(d)
                        {
                          
                          d['column_filter[q_promo_code]']     = $("input[name='q_promo_code']").val()
                          d['column_filter[q_promo_status]']   = $("select[name='q_promo_status']").val()
            ...
            columns: [
                  ...
                  {data: 'is_active',
                    ...
                    {   
                        if(row.is_active == 1)
                        {
                            return `<input type="checkbox" checked data-size="small"  data-enc_id="`+row.id+`" id="status_'.$data->id.'"  class="js-switch toggleSwitch" data-type="deactivate" data-color="#99d683" action="deactivate"  data-secondary-color="#f96262" onchange="change_status(this)"/>`
                        }
                        else
                        {
                  ...
                  {                  
                    render(data, type, row, meta)
                    {
                         return `
                          ...
                          <a href="`+module_url_path+`/edit/`+row.id+`" data-toggle="tooltip"  data-size="small" title="Edit" class="btn btn-outline btn-primary btn-circle show-tooltip">Edit</a>
