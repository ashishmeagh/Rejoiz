          ...
          @endphp
                   ...
                   <div class="main-all-current-promotions">
                        ...
                        <div class="main-all-current-promotions-right">
                            ...
                            <ul class="promotions-ul">
                                ...
                                @if(isset($promotion_arr['get_promotions_offer_details']) && count($promotion_arr['get_promotions_offer_details'])>0)
                                    ...
                                    @foreach($promotion_arr['get_promotions_offer_details'] as $key=>$promotions_offer)
                                        ...
                                        <li>Orders under ${{$promotions_offer['minimum_ammount']}} receive {{$promotions_offer['discount']}}% off</li>
                           ...
                           @if(isset($promotion_arr['promo_code']) && $promotion_arr['promo_code']!='') 
                           <div class="button-ff-year">{{$promotion_arr['promo_code'] or ''}}</div> 
                           @endif
      ...
      <div class="form-group row">
         <div class="col-md-12">
            <div class="text-center">
               <a class="btn btn-inverse waves-effect waves-light pull-left" href="{{URL::previous()}}"><i class="fa fa-arrow-left"></i><i class="fa fa-arrow-left"></i> Back</a>
            </div>
         </div>
      </div>
