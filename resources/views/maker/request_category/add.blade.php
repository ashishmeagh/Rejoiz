                ...
                @if(isset($arr_lang) && sizeof($arr_lang)>0)
                      ...
                      <div class="tab-pane fade {{ $lang['locale']=='en'?'in active':'' }}" 
                       ...
                       <div class="row">
                          ...
                          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-10 controls">
                             @if($lang['locale'] == 'en')        
                             {!! Form::text('category_name_'.$lang['locale'],old('category_name_'.$lang['locale']),['class'=>'form-control','data-parsley-required'=>'true','data-parsley-pattern'=>'^[a-zA-Z&/ ]+$','data-parsley-pattern-message'=>'Please enter valid category name','data-parsley-required-message'=>'Please enter request category name','data-parsley-minlength'=>'3','data-parsley-minlength-message'=>'Category name is invalid.It should be atleast 3 characters long','placeholder'=>'Enter Request Category Name']) !!}
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-10">
                     <input type="file" name="category_image" id="category_image" class="dropify" {{-- data-default-file="{{url('/')}}/uploads/default.jpeg" --}} data-parsley-required ="true" data-parsley-required-message="Please select request category image" data-parsley-errors-container="#err_container" data-allowed-file-extensions="png jpg JPG jpeg JPEG" data-max-file-size="2M" data-errors-position="outside" />
