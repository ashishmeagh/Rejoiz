      ...
      <div class="white-box small-space-nw">
        <div class="row">
          <div class="col-sm-12 col-md-6 col-lg-6 orders_view">
              <div class="row"> 
                  <label class="col-xs-12 col-sm-12 col-md-4 col-lg-4 commonlabel_bold"><span class="semibold-mkr">Order No.</span></label>
              ...
              <div class="row">
                  <label class="col-xs-12 col-sm-12 col-md-4 col-lg-4 commonlabel_bold"><span class="semibold-mkr">Order Date</span></label>
                  <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
              ...
              <div class="row">
                  <label class="col-xs-12 col-sm-12 col-md-4 col-lg-4 commonlabel_bold"><span class="semibold-mkr">Shipping Address</span></label>
                  <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
              ...
              <div class="row">
                    <label class="col-xs-12 col-sm-12 col-md-4 col-lg-4 commonlabel_bold"><span class="semibold-mkr">Payment Status</span></label>
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                        @php
               ...
               @if(isset($enquiry_arr['promo_code']) && $enquiry_arr['promo_code'] != '')
                  ...
                  <div class="row">
                    <label class="col-xs-12 col-sm-12 col-md-4 col-lg-4 commonlabel_bold"><span class="semibold-mkr">Promo Code</span></label>
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
          ...
          <div class="col-sm-12 col-md-6 col-lg-6 orders_view">
             <div class="row">
                  <label class="col-xs-12 col-sm-12 col-md-4 col-lg-4 commonlabel_bold"><span class="semibold-mkr">Customer</span></label>
                  <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                    <span>{{isset($enquiry_arr['user_details']['first_name'])?ucfirst($enquiry_arr['user_details']['first_name']):""}} {{isset($enquiry_arr['user_details']['last_name'])?ucfirst($enquiry_arr['user_details']['last_name']):""}}</span>
                  </div>
              </div>

               <div class="row">
                  <label class="col-xs-12 col-sm-12 col-md-4 col-lg-4 commonlabel_bold"><span class="semibold-mkr">Total Amount</span></label>
                  <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
               ...
               <div class="row">
                  <label class="col-xs-12 col-sm-12 col-md-4 col-lg-4 commonlabel_bold"><span class="semibold-mkr">Billing Addresss</span></label>
                  <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
