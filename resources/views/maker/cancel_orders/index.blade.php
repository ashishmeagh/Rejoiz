         ...
         <div class="col-lg-12">
            ...
            <div class="white-box">
              ...
              <div class="pull-right top_small_icon">            
                ...
                <button type="button" onclick="retailerCancelOrderExport()" title="Export retailer cancel order transaction as .csv" class="btn btn-success waves-effect waves-light filter_btn pull-right mr-2 ml-2" value="export" id="retailerCancelOrderExport">Export</button>           
              </div> 
...
function retailerCancelOrderExport(){ 
    ...
    $.ajax({
          url: module_url_path+'/get_export_retailer_cancel_order',
          data: {q_order_no:q_order_no,q_retailer_name:q_retailer_name,q_enquiry_date:q_enquiry_date,q_total_wholesale_cost:q_total_wholesale_cost,q_payment_status:q_payment_status,q_order_from_date:q_order_from_date,q_order_to_date:q_order_to_date,q_refund_status:q_refund_status},
          ...
          success:function(data)
          {
            ...
            {
              saveData(data, 'retailer_cancel_order.csv');
            }
          }
        });
 }
