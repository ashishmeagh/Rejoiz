    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <div class="white-box">
          ...
          <button type="button" onclick="retailerRefundExport()" title="Export customer refund transaction as .csv" class="btn btn-success waves-effect waves-light filter_btn pull-right mr-2 ml-2" value="export" id="retailerRefundExport">Export</button>
...
function retailerRefundExport(){ 
    ...
    $.ajax({
          url: module_url_path+'/get_export_retailer_refund_transaction',
