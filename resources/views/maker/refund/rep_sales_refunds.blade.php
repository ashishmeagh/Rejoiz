    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <div class="white-box">
          ...
          <button type="button" onclick="repsSalesRefundExport()" title="Export reps/sales refund transaction as .csv" class="btn btn-success waves-effect waves-light filter_btn pull-right mr-2 ml-2" value="export" id="repsSalesRefundExport">Export</button>
  ...
  $(document).ready(function()
  {
    ...
    'data': function(d)
      ...
      { 
       ...
       {data: 'dummy_store_name', "orderable": true, "searchable":false},
...
function repsSalesRefundExport(){ 
    ...
    $.ajax({
          url: module_url_path+'/get_export_reps_sales_refund_transactions',
          data: {q_username:q_username,q_transaction_id:q_transaction_id,q_amount:q_amount,q_transaction_status:q_transaction_status,q_created_at:q_created_at,q_order_no:q_order_no},
          ...
          success:function(data)
          {
            ...
            {
              saveData(data, 'rep_sales_refund_transaction.csv');
            }
          }
        });
 }
