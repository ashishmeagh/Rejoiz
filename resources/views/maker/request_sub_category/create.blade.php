            ...
            <div class="col-sm-12 col-xs-12">
               ...
               <div  class="tab-content">
                ...
                <div class="row m-b-15">
                        <label for="categories" class="col-sm-12 col-md-12 col-lg-2 col-form-label">Select Category <i class="red">*</i></label>
                    ...
                    @foreach($arr_lang as $lang)
                      ...
                      <div class="tab-pane fade {{ $lang['locale']=='en'?'in active':'' }}" 
                       ...
                       <div class="row m-b-15">
                          ...
                          <div class="col-sm-12 col-md-12 col-lg-10 controls">
                             @if($lang['locale'] == 'en')        
                             {!! Form::text('sub_category_name_'.$lang['locale'],old('sub_category_name_'.$lang['locale']),['class'=>'form-control','data-parsley-required'=>'true','data-parsley-pattern'=>'^[a-zA-Z&/ ]+$','data-parsley-pattern-message'=>'Please enter valid subcategory name','data-parsley-required-message'=>'Please enter subcategory name','data-parsley-minlength'=>'3','data-parsley-minlength-message'=>'Subcategory name is invalid.It should be atleast 3 characters long', 'placeholder'=>'Subcategory Name']) !!}
                             @else
