...
.catlog-img img{width:100% !important; border:1px solid #e4e4e4;}
.catlog-img{
  padding:3px;
}
</style>
...
<div class="container-fluid">
   <div class="row bg-title">
      <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
         ...
         <h4 class="page-title">Manage Catalog Pages</h4>
      </div>
      <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
         <ol class="breadcrumb">
            <li><a href="{{url('/')}}/{{$maker_panel_slug or ''}}/dashboard">Dashboard</a></li>
            <li><a href="{{$module_catalog_url}}">{{$module_title or ''}}</a></li>
   ...
   <div class="col-sm-12">
      <div class="white-box">
          ...
          <h4>Catalog Name: {{isset($catalog_name)?$catalog_name:'N/A'}}</h4>
          <div class="pull-right">
     
            <div class="pull-right top_small_icon">
              

                <a  href="{{$module_url_path.'/create'}}/{{isset($catalog_id)?base64_encode($catalog_id):''}}" class="btn btn-outline btn-info btn-circle show-tooltip" title="Add new page"><i class="ti-plus"></i></a> 
...
<script type="text/javascript">
  ...
  $(document).ready(function() 
  {
      ...
      stateSave: true,
            ...
            columns: [
                  ...
                  {data:'page_preview',"orderable": false, "searchable":false},
                  ...
                  {                  
                    ...
                    {
                         return `
                          <a href="`+module_url_path+`/edit/`+btoa(row.id)+`" data-toggle="tooltip"  data-size="small" title="Edit Page" class="btn btn-circle btn-success btn-outline show-tooltip">Edit</a>

                           <a href="`+module_url_path+`/view_catalog_page/`+btoa(row.id)+`" data-toggle="tooltip"  data-size="small" title="View Page" class="btn btn-circle btn-success btn-outline show-tooltip">View</a>
                           
                           <a href="`+module_url_path+`/delete_catalog_pages/`+btoa(row.id)+`" data-toggle="tooltip"  data-size="small" title="Delete Page" class="btn btn-outline btn-primary btn-circle show-tooltip btn-retailer-view" onclick="confirm_delete(this,event);">Delete</a>
    ...
    function change_status(reference)
    {
           ...
           /*console.log(module_url_path+'/change_status');*/
           $.ajax({
  ...
  {
    confirm_action(ref,event,'Are you sure? Do you want to delete this catalog page.');
  }
