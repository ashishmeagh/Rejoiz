                    ...
                    {!! Form::open([ 'url' => $module_url_path.'/multi_action',
                        ...
                        <div class="sub_category_table_top_div mb-5">
                                    ...
                                    <select name="service_category" id="service_category" class="form-control column_filter" onchange="filterData()">
                                        ...
                                        @if(isset($categories_arr) && count($categories_arr) >0)
                                            @foreach($categories_arr as $category)
                                                <option value="{{ isset($category['id']) && $category['id'] !='' ?$category['id'] :'' }}">{{ isset($category['category_name']) && $category['category_name'] !='' ? $category['category_name'] : '' }}</option>
                                            @endforeach
                                        @else
                                            No Record Found
                                        @endif
                            ...
                            <div class="pull-right text-right top_small_icon">
                                <a href="{{ url($module_url_path.'/create') }}" class="btn btn-outline btn-info btn-circle show-tooltip" title="Add third level category"><i class="fa fa-plus"></i> </a> 
...
<script type="text/javascript">
  ...
  var table_module = false;
    ...
    function change_status(reference)
    {
        ...
        if(action == 'activate')
        {
           var msg = 'Are you sure? Do you want to activate this subcategory.';
        }
        else if(action == 'deactivate')
        {
          var msg = 'Are you sure? Do you want to deactivate this subcategory.'; 
        }
