...
<div id="page-wrapper">
 ...
 --}}
           {{--  <a  href="javascript:void(0);" onclick="javascript : return check_multi_action('checked_record[]','frm_manage','delete');" class="btn btn-circle btn-danger btn-outline show-tooltip" title="Multiple Delete"><i class="ti-trash"></i> </a>   --}}
            ...
            <button type="button" onclick="vendorTransactionExport()" title="Export vendor transaction as .csv" class="btn btn-success waves-effect waves-light filter_btn pull-right mr-2 " value="export" id="vendorTransactionExport">Export</button>
...
<script type="text/javascript">
  ...
  $(document).ready(function()
  {
      ...
      bFilter: false ,
      ajax: {
      'url': '{{ $module_url_path}}/vendor_transaction',
...
function vendorTransactionExport(){ 
    ...
    var q_transfer_id         = $("input[name='q_transfer_id']").val()

    $.ajax({
          url: module_url_path+'/get_export_vendor_transaction',
          data: {q_transaction_id:q_transaction_id,q_amount:q_amount,q_transaction_status:q_transaction_status,q_created_at:q_created_at,q_order_no:q_order_no,q_transfer_id:q_transfer_id},
          ...
          success:function(data)
          {
            ...
            {
              saveData(data, 'vendor_transaction.csv');
            }
          }
        });
 }
