...
<div id="page-wrapper">
 ...
 --}}
           {{--  <a  href="javascript:void(0);" onclick="javascript : return check_multi_action('checked_record[]','frm_manage','delete');" class="btn btn-circle btn-danger btn-outline show-tooltip" title="Multiple Delete"><i class="ti-trash"></i> </a>   --}}
            ...
            <button type="button" onclick="adminTransactionExport()" title="Export admin transaction as .csv" class="btn btn-success waves-effect waves-light filter_btn pull-right mr-2 " value="export" id="adminTransactionExport">Export</button>
...
<script type="text/javascript">
  ...
  $(document).ready(function()
  {
      ...
      bFilter: false ,
      ajax: {
      'url': '{{ $module_url_path}}/admin_transaction',
...
function adminTransactionExport(){ 
    ...
    $.ajax({
          url: module_url_path+'/get_export_admin_transaction',
          ...
          success:function(data)
          {
            ...
            {
              saveData(data, 'admin_transaction.csv');
            }
          }
        });
 }
